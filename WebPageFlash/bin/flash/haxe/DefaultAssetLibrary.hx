...
@:keep @:bind #if display private #end class __ASSET__wav_0_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_1_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_2_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_3_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_4_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_81_data extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__wav_dummy_txt extends flash.utils.ByteArray { }
