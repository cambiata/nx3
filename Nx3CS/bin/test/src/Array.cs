...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public    Array(){
		unchecked {
			#line 53 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public static   void __hx_ctor__Array<T_c>(global::Array<T_c> __temp_me4){
		unchecked {
			#line 55 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			__temp_me4.length = 0;
	...
	public   global::Array<T> concat(global::Array<T> a){
		unchecked {
			#line 61 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			...
			#line 66 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void concatNative(T[] a){
		unchecked {
			...
			if (( ( __a as global::System.Array ).Length >= len )) {
				...
				#line 81 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.__a = newarr;
			}
			
			#line 84 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			this.length = len;
		}
		#line default
	}
	...
	public   int indexOf(T x, global::haxe.lang.Null<int> fromIndex){
		unchecked {
			#line 89 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int len = this.length;
			#line 89 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int i = default(int);
			#line 89 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			...
			#line 90 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( i < 0 )) {
				#line 92 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				i += len;
				if (( i < 0 )) {
					#line 93 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					i = 0;
				}
				
			}
			
			#line 95 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   int lastIndexOf(T x, global::haxe.lang.Null<int> fromIndex){
		unchecked {
			#line 100 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int len = this.length;
			#line 100 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int i = default(int);
			#line 100 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			...
			#line 101 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( i >= len )) {
				#line 103 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				i = ( len - 1 );
			}
			 else {
				#line 105 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( i < 0 )) {
					#line 107 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					i += len;
					if (( i < 0 )) {
						#line 108 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						return -1;
					}
			...
			#line 110 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   string @join(string sep){
		unchecked {
			#line 115 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			global::StringBuf buf = new global::StringBuf();
			int i = -1;
			#line 118 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			bool first = true;
			int length = this.length;
			while ((  ++ i < length )){
				#line 122 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (first) {
					#line 123 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					first = false;
				}
				 else {
					#line 125 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					buf.b.Append(((object) (global::Std.@string(sep)) ));
				}
				
				#line 126 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				buf.b.Append(((object) (global::Std.@string(this.__a[i])) ));
			}
			
			#line 129 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return buf.toString();
		}
		#line default
	}
	...
	public   global::haxe.lang.Null<T> pop(){
		unchecked {
			#line 134 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] __a = this.__a;
			int length = this.length;
			if (( length > 0 )) {
				#line 138 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				T val = __a[ -- length];
				__a[length] = default(T);
				this.length = length;
				#line 142 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return new global::haxe.lang.Null<T>(val, true);
			}
			 else {
				#line 144 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   int push(T x){
		unchecked {
			#line 150 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( this.length >= ( this.__a as global::System.Array ).Length )) {
				#line 152 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				...
				#line 156 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.__a = newarr;
			}
			
			#line 159 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void reverse(){
		unchecked {
			#line 165 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int i = 0;
			int l = this.length;
			T[] a = this.__a;
			int half = ( l >> 1 );
			l -= 1;
			while (( i < half )){
				#line 172 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				T tmp = a[i];
				a[i] = a[( l - i )];
				a[( l - i )] = tmp;
				i += 1;
	...
	public   global::haxe.lang.Null<T> shift(){
		unchecked {
			#line 181 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int l = this.length;
			if (( l == 0 )) {
				#line 183 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return default(global::haxe.lang.Null<T>);
			}
			
			#line 185 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] a = this.__a;
			T x = a[0];
			l -= 1;
			...
			a[l] = default(T);
			this.length = l;
			#line 192 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   global::Array<T> slice(int pos, global::haxe.lang.Null<int> end){
		unchecked {
			#line 197 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos < 0 )) {
				#line 198 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 200 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					pos = 0;
				}
				
			}
			
			#line 202 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if ( ! (end.hasValue) ) {
				#line 203 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				end = new global::haxe.lang.Null<int>(this.length, true);
			}
			 else {
				#line 204 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( end.@value < 0 )) {
					#line 205 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					end = new global::haxe.lang.Null<int>(( this.length + end.@value ), true);
				}
				
			}
			
			#line 206 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( end.@value > this.length )) {
				#line 207 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				end = new global::haxe.lang.Null<int>(this.length, true);
			}
			
			#line 208 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int len = ( end.@value - pos );
			if (( len < 0 )) {
				#line 209 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return new global::Array<T>();
			}
			
			#line 211 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] newarr = new T[((int) (len) )];
			global::System.Array.Copy(((global::System.Array) (this.__a) ), ((int) (pos) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (len) ));
			#line 214 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void sort(global::haxe.lang.Function f){
		unchecked {
			#line 219 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( this.length == 0 )) {
				#line 220 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return ;
			}
			
			#line 221 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   void quicksort(int lo, int hi, global::haxe.lang.Function f){
		unchecked {
			#line 226 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] buf = this.__a;
			int i = lo;
			#line 227 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int j = hi;
			T p = buf[( ( i + j ) >> 1 )];
			while (( i <= j )){
				#line 231 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				while (( ((int) (f.__hx_invoke2_f(default(double), buf[i], default(double), p)) ) < 0 )){
					#line 231 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					i++;
				}
				
				#line 232 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				while (( ((int) (f.__hx_invoke2_f(default(double), buf[j], default(double), p)) ) > 0 )){
					#line 232 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					j--;
				}
				
				#line 233 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( i <= j )) {
					#line 235 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					T t = buf[i];
					buf[i++] = buf[j];
					buf[j--] = t;
				}
			...
			#line 241 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( lo < j )) {
				#line 241 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.quicksort(lo, j, f);
			}
			
			#line 242 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( i < hi )) {
				#line 242 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   global::Array<T> splice(int pos, int len){
		unchecked {
			#line 247 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( len < 0 )) {
				#line 247 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return new global::Array<T>();
			}
			
			#line 248 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos < 0 )) {
				#line 249 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 250 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					pos = 0;
				}
				
			}
			
			#line 252 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos > this.length )) {
				#line 253 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = 0;
				len = 0;
			}
			 else {
				#line 255 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( ( pos + len ) > this.length )) {
					#line 256 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					len = ( this.length - pos );
					if (( len < 0 )) {
						#line 257 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						len = 0;
					}
			...
			#line 259 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] a = this.__a;
			#line 261 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] ret = new T[((int) (len) )];
			...
			#line 265 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int end = ( pos + len );
			global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 269 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				a[( this.length + len )] = default(T);
			}
			
			#line 270 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return ret1;
		}
		#line default
	}
	...
	public   void spliceVoid(int pos, int len){
		unchecked {
			#line 275 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( len < 0 )) {
				#line 275 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return ;
			}
			
			#line 276 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos < 0 )) {
				#line 277 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = ( this.length + pos );
				if (( pos < 0 )) {
					#line 278 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					pos = 0;
				}
				
			}
			
			#line 280 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos > this.length )) {
				#line 281 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = 0;
				len = 0;
			}
			 else {
				#line 283 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( ( pos + len ) > this.length )) {
					#line 284 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					len = ( this.length - pos );
					if (( len < 0 )) {
						#line 285 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						len = 0;
					}
			...
			#line 287 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] a = this.__a;
			#line 289 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int end = ( pos + len );
			global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
			this.length -= len;
			while ((  -- len >= 0 )){
				#line 293 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				a[( this.length + len )] = default(T);
			}
	...
	public   string toString(){
		unchecked {
			#line 298 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			global::StringBuf ret = new global::StringBuf();
			T[] a = this.__a;
			ret.b.Append(((object) ("[") ));
			bool first = true;
			{
				#line 302 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int _g1 = 0;
				#line 302 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int _g = this.length;
				#line 302 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				while (( _g1 < _g )){
					#line 302 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					int i = _g1++;
					#line 304 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					if (first) {
						#line 305 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						first = false;
					}
					 else {
						#line 307 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						ret.b.Append(((object) (",") ));
					}
					
					#line 308 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					ret.b.Append(((object) (global::Std.@string(a[i])) ));
				}
				
			}
			
			#line 311 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			ret.b.Append(((object) ("]") ));
			return ret.toString();
		}
		#line default
	...
	public   void insert(int pos, T x){
		unchecked {
			#line 336 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int l = this.length;
			if (( pos < 0 )) {
				#line 338 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				pos = ( l + pos );
				if (( pos < 0 )) {
					#line 339 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					pos = 0;
				}
				
			}
			
			#line 341 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( pos >= l )) {
				#line 342 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.push(x);
				return ;
			}
			 else {
				#line 344 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (( pos == 0 )) {
					#line 345 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					this.unshift(x);
					return ;
				}
			...
			#line 349 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( l >= ( this.__a as global::System.Array ).Length )) {
				#line 351 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int newLen = ( (( this.length << 1 )) + 1 );
				T[] newarr = new T[((int) (newLen) )];
				...
				#line 357 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.__a = newarr;
				 ++ this.length;
			}
			 else {
				#line 360 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				T[] __a = this.__a;
	...
	public   bool @remove(T x){
		unchecked {
			#line 370 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] __a = this.__a;
			int i = -1;
			int length = this.length;
			while ((  ++ i < length )){
				#line 375 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				if (global::haxe.lang.Runtime.eq(__a[i], x)) {
					#line 377 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					...
					#line 380 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					return true;
				}
				
			}
			
			#line 384 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return false;
		}
		#line default
	}
	...
	public   global::Array<S> map<S>(global::haxe.lang.Function f){
		unchecked {
			#line 388 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			global::Array<S> ret = new global::Array<S>(new S[]{});
			{
				#line 389 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int _g = 0;
				#line 389 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			...
			#line 391 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return ret;
		}
		#line default
	}
	...
	public   global::Array<T> filter(global::haxe.lang.Function f){
		unchecked {
			#line 395 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			global::Array<T> ret = new global::Array<T>(new T[]{});
			{
				#line 396 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				int _g = 0;
				#line 396 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				global::Array<T> _g1 = this;
				#line 396 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				while (( _g < _g1.length )){
					...
					if (global::haxe.lang.Runtime.toBool(f.__hx_invoke1_o(default(double), elt))) {
						#line 398 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
						ret.push(elt);
					}
			...
			#line 399 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return ret;
		}
		#line default
	}
	...
	public   global::Array<T> copy(){
		unchecked {
			#line 404 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			int len = this.length;
			T[] __a = this.__a;
			T[] newarr = new T[((int) (len) )];
	...
	public   object iterator(){
		unchecked {
			#line 413 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   T __get(int idx){
		unchecked {
			#line 418 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			T[] __a = this.__a;
			uint idx1 = ((uint) (idx) );
			if (( idx1 >= this.length )) {
				#line 421 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				return default(T);
			}
			
			#line 423 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return __a[((int) (idx1) )];
		}
		#line default
	}
	...
	public   T __set(int idx, T v){
		unchecked {
			#line 428 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			uint idx1 = ((uint) (idx) );
			T[] __a = this.__a;
			if (( idx1 >= ( __a as global::System.Array ).Length )) {
				#line 432 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				uint len = ( idx1 + 1 );
				if (( idx1 == ( __a as global::System.Array ).Length )) {
					#line 434 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
					len = ((uint) (( (( idx1 << 1 )) + 1 )) );
				}
				
				#line 435 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				T[] newArr = new T[((int) (len) )];
				( __a as global::System.Array ).CopyTo(((global::System.Array) (newArr) ), ((int) (0) ));
				this.__a = __a = newArr;
			}
			
			#line 440 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			if (( idx1 >= this.length )) {
				#line 441 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				this.length = ((int) (( idx1 + 1 )) );
			}
			
			#line 443 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
	...
	public   T __unsafe_get(int idx){
		unchecked {
			#line 448 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
			return this.__a[idx];
		}
		#line default
	}
	...
	public   T __unsafe_set(int idx, T val){
		unchecked {
			#line 453 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
...
namespace _Array{
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		...
		public    ArrayIterator(global::Array<T> a){
			unchecked {
				#line 464 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
		...
		public static   void __hx_ctor__Array_ArrayIterator<T_c>(global::_Array.ArrayIterator<T_c> __temp_me5, global::Array<T_c> a){
			unchecked {
				#line 466 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
				__temp_me5.arr = a;
		...
		public   bool hasNext(){
			unchecked {
				#line 471 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
		...
		public   T next(){
			unchecked {
				#line 472 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Array.hx"
