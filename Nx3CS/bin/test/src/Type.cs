...
public  class ValueType : global::haxe.lang.Enum {
	static ValueType() {
		#line 50 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
		...
		#line 59 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   global::ValueType TClass(global::System.Type c){
		unchecked {
			#line 57 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   global::ValueType TEnum(global::System.Type e){
		unchecked {
			#line 58 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
...
public  class Type : global::haxe.lang.HxObject {
	...
	public static   global::System.Type getSuperClass(global::System.Type c){
		unchecked {
			#line 87 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			...
			if (( ( global::haxe.lang.Runtime.typeEq(@base, default(global::System.Type)) || string.Equals(global::haxe.lang.Runtime.concat(global::Std.@string(@base), ""), "haxe.lang.HxObject") ) || string.Equals(global::haxe.lang.Runtime.concat(global::Std.@string(@base), ""), "System.Object") )) {
				#line 91 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				return default(global::System.Type);
			}
			
			#line 94 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   string getClassName(global::System.Type c){
		unchecked {
			#line 98 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			string ret = global::haxe.lang.Runtime.toString(((global::System.Type) (c) ));
			#line 104 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			switch (ret){
				case "System.Int32":
				{
					#line 106 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return "Int";
				}
				...
				case "System.Double":
				{
					#line 107 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return "Float";
				}
				...
				case "System.String":
				{
					#line 108 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return "String";
				}
				...
				case "System.Object":
				{
					#line 109 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return "Dynamic";
				}
				...
				case "System.Type":
				{
					#line 110 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return "Class";
				}
				...
				default:
				{
					#line 111 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   string getEnumName(global::System.Type e){
		unchecked {
			#line 117 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			string ret = global::haxe.lang.Runtime.toString(((global::System.Type) (e) ));
			#line 122 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			if (( ( ret.Length == 14 ) && string.Equals(ret, "System.Boolean") )) {
				#line 123 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				return "Bool";
			}
			
			#line 124 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			return ret;
		}
		#line default
	}
	...
	public static   global::System.Type resolveClass(string name){
		unchecked {
			#line 133 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			...
			if (global::haxe.lang.Runtime.typeEq(t, default(global::System.Type))) {
				#line 136 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				switch (name){
					case "Int":
					{
						#line 138 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					...
					case "Float":
					{
						#line 139 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					...
					case "Class":
					{
						#line 140 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					...
					case "Dynamic":
					{
						#line 141 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					...
					case "String":
					{
						#line 142 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					...
					default:
					{
						#line 143 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
						return default(global::System.Type);
					}
				...
				if (( t.IsInterface && (((global::System.Type) (typeof(global::haxe.lang.IGenericObject)) )).IsAssignableFrom(((global::System.Type) (t) )) )) {
					...
					#line 156 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return ((global::System.Type) (t) );
				}
				 else {
					#line 158 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					return ((global::System.Type) (t) );
				}
	...
	public static   T createInstance<T>(global::System.Type cl, global::Array args){
		unchecked {
			#line 177 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			if (global::haxe.lang.Runtime.refEq(cl, typeof(string))) {
				#line 178 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				return global::haxe.lang.Runtime.genericCast<T>(args[0]);
			}
			
			#line 179 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			global::System.Type t = ((global::System.Type) (cl) );
			if (t.IsInterface) {
				#line 183 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				global::System.Type cl1 = global::Type.resolveClass(global::Type.getClassName(cl));
				#line 183 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				t = cl1;
			}
			
			#line 185 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   T createEmptyInstance<T>(global::System.Type cl){
		unchecked {
			#line 191 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			global::System.Type t = ((global::System.Type) (cl) );
			if (t.IsInterface) {
				#line 195 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				global::System.Type cl1 = global::Type.resolveClass(global::Type.getClassName(cl));
				#line 195 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
				t = cl1;
			}
			
			#line 198 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			if (global::Reflect.hasField(cl, "__hx_createEmpty")) {
				#line 199 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			...
			#line 200 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   T createEnumIndex<T>(global::System.Type e, int index, global::Array @params){
		unchecked {
			#line 220 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
	...
	public static   global::Array<object> getEnumConstructs(global::System.Type e){
		unchecked {
			#line 272 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			if (global::Reflect.hasField(e, "constructs")) {
				#line 273 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			...
			#line 274 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
		...
		unchecked {
			...
			global::Array<T> ret = new global::Array<T>(new T[]{});
			{
				...
				while (( _g < ctors.length )){
					...
					#line 377 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					 ++ _g;
					#line 379 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
					T v = global::haxe.lang.Runtime.genericCast<T>(global::Reflect.field(e, ctor));
					if (global::Std.@is(v, e)) {
						#line 381 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
						ret.push(v);
					}
			...
			#line 384 "F:\\HaxeToolkit\\haxe\\std\\cs\\_std\\Type.hx"
			return ret;
		}
		#line default
	}
