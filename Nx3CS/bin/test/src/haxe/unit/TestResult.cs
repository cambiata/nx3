...
namespace haxe.unit{
	public  class TestResult : global::haxe.lang.HxObject {
		public    TestResult(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 24 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
				{
				}
		...
		public    TestResult(){
			unchecked {
				#line 29 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
		...
		public static   void __hx_ctor_haxe_unit_TestResult(global::haxe.unit.TestResult __temp_me60){
			unchecked {
				#line 30 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
				__temp_me60.m_tests = new global::List<object>();
				__temp_me60.success = true;
			}
			#line default
		}
		...
		public virtual   void @add(global::haxe.unit.TestStatus t){
			unchecked {
				#line 35 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
				this.m_tests.@add(t);
				if ( ! (t.success) ) {
					#line 37 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
					this.success = false;
				}
		...
		public virtual   string toString(){
			unchecked {
				#line 41 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
				global::StringBuf buf = new global::StringBuf();
				int failures = 0;
				{
					#line 43 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
					object __temp_iterator237 = this.m_tests.iterator();
					#line 43 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
					while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator237, "hasNext", 407283053, default(global::Array)))){
						#line 43 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
						global::haxe.unit.TestStatus test = ((global::haxe.unit.TestStatus) (global::haxe.lang.Runtime.callField(__temp_iterator237, "next", 1224901875, default(global::Array))) );
						if (( test.success == false )) {
							#line 45 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							buf.b.Append(((object) ("* ") ));
							...
							buf.b.Append(((object) ("()") ));
							buf.b.Append(((object) ("\n") ));
							#line 52 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							buf.b.Append(((object) ("ERR: ") ));
							if (( ! (global::haxe.lang.Runtime.refEq(test.posInfos, default(object))) )) {
								#line 54 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							...
							#line 63 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							buf.b.Append(((object) (global::Std.@string(test.error)) ));
							buf.b.Append(((object) ("\n") ));
							#line 66 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							if ( ! (string.Equals(test.backtrace, default(string))) ) {
								#line 67 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
								buf.b.Append(((object) (global::Std.@string(test.backtrace)) ));
								buf.b.Append(((object) ("\n") ));
							}
							
							#line 71 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
							buf.b.Append(((object) ("\n") ));
							failures++;
						}
				...
				#line 75 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
				buf.b.Append(((object) ("\n") ));
				if (( failures == 0 )) {
					#line 77 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
					buf.b.Append(((object) ("OK ") ));
				}
				 else {
					#line 79 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
					buf.b.Append(((object) ("FAILED ") ));
				}
				
				#line 81 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestResult.hx"
