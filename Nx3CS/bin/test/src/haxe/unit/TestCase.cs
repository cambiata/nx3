...
namespace haxe.unit{
	public  class TestCase : global::haxe.lang.HxObject {
		public    TestCase(global::haxe.lang.EmptyObject empty){
			unchecked {
				#line 27 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				{
				}
		...
		public static   void __hx_ctor_haxe_unit_TestCase(global::haxe.unit.TestCase __temp_me57){
			unchecked {
				#line 30 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				{
				}
		...
		public virtual   void setup(){
			unchecked {
				#line 33 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				{
				}
		...
		public virtual   void tearDown(){
			unchecked {
				#line 36 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				{
				}
		...
		public virtual   void print(object v){
			unchecked {
				#line 40 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
		...
		public virtual   void assertTrue(bool b, object c){
			unchecked {
				#line 44 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				this.currentTest.done = true;
				if (( b == false )) {
					#line 46 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
		...
		public virtual   void assertFalse(bool b, object c){
			unchecked {
				#line 54 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				this.currentTest.done = true;
				if (( b == true )) {
					#line 56 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
					this.currentTest.success = false;
		...
		public virtual   void assertEquals<T>(T expected, T actual, object c){
			unchecked {
				#line 64 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
				this.currentTest.done = true;
				if (( ! (global::haxe.lang.Runtime.eq(actual, expected)) )) {
					#line 66 "F:\\HaxeToolkit\\haxe\\std\\haxe\\unit\\TestCase.hx"
					this.currentTest.success = false;
