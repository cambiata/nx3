...
namespace haxe.lang{
	public  class StringExt {
		public    StringExt(){
			unchecked {
				#line 26 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				{
				}
		...
		public static   string toString(string me){
			unchecked {
				#line 181 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				return me;
			}
			#line default
		}
		...
		public static   string toNativeString(string me){
			unchecked {
				#line 202 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				return me;
			}
			#line default
		}
...
namespace haxe.lang{
	public  class StringRefl {
		static StringRefl() {
			#line 216 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
		...
		public    StringRefl(){
			unchecked {
				#line 214 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				{
				}
		...
		public static   object handleGetField(string str, string f, bool throwErrors){
			unchecked {
				#line 220 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				switch (f){
					case "length":
					{
						#line 222 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
						return str.Length;
					}
					...
					{
						#line 224 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
					...
					default:
					{
						#line 226 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
						if (throwErrors) {
							#line 227 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
							...
							#line 229 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
		...
		public static   object handleCallField(string str, string f, global::Array args){
			unchecked {
				#line 235 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
				global::Array _args = new global::Array<object>(new object[]{str});
				if (( args == default(global::Array) )) {
					#line 237 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
					args = _args;
				}
				 else {
					#line 239 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
					args = ((global::Array) (global::haxe.lang.Runtime.callField(_args, "concat", 1204816148, new global::Array<object>(new object[]{args}))) );
				}
				
				#line 241 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\StringExt.hx"
