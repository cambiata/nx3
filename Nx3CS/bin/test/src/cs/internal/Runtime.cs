...
namespace haxe.lang{
	...
	public static object callField(haxe.lang.HxObject obj, string field, int fieldHash, Array args)
	{
		...
		static Runtime() {
			#line 69 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
		...
		public    Runtime(){
			unchecked {
				#line 67 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				{
				}
		...
		public static   object callMethod(object obj, global::System.Reflection.MethodBase[] methods, int methodLength, global::Array args){
			unchecked {
				#line 465 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( methodLength == 0 )) {
					#line 465 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					throw global::haxe.lang.HaxeException.wrap("No available methods");
				}
				
				#line 466 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				...
				#line 471 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				{
					#line 471 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					int _g = 0;
					#line 471 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					while (( _g < ((int) (length) ) )){
						#line 471 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						int i = _g++;
						#line 473 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						oargs[i] = args[i];
						if (( ! (global::haxe.lang.Runtime.eq(args[i], default(object))) )) {
							#line 475 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				...
				#line 478 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				int last = 0;
				#line 481 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( methodLength > 1 )) {
					#line 483 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					{
						#line 483 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						int _g1 = 0;
						#line 483 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						while (( _g1 < methodLength )){
							#line 483 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							int i1 = _g1++;
							#line 485 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							global::System.Reflection.ParameterInfo[] @params = methods[i1].GetParameters();
							if (( ( @params as global::System.Array ).Length != length )) {
								#line 487 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
								continue;
							}
							 else {
								#line 489 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
								bool fits = true;
								#line 489 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
								int crate = 0;
								{
									#line 490 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
									int _g2 = 0;
									#line 490 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
									...
									while (( _g2 < _g11 )){
										#line 490 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
										int i2 = _g2++;
										#line 492 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
										...
										if (param.IsAssignableFrom(((global::System.Type) (ts[i2]) ))) {
											#line 497 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
											continue;
										}
										 else {
											#line 498 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
											if (( strParam.StartsWith("haxe.lang.Null") || ( (( global::haxe.lang.Runtime.eq(oargs[i2], default(object)) || ( oargs[i2] is global::System.IConvertible ) )) && (((global::System.Type) (typeof(global::System.IConvertible)) )).IsAssignableFrom(((global::System.Type) (param) )) ) )) {
												#line 501 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
												crate++;
												continue;
											}
											 else {
												#line 503 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
												if ( ! (param.ContainsGenericParameters) ) {
													#line 504 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
													fits = false;
													break;
												}
								...
								#line 509 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
								if (fits) {
									#line 511 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
									rates[last] = crate;
					...
					#line 517 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					methodLength = last;
				}
				 else {
					#line 518 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					if (( ( methodLength == 1 ) && ( ( methods[0].GetParameters() as global::System.Array ).Length != length ) )) {
						#line 519 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						methodLength = 0;
					}
					
				}
				
				#line 527 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( methodLength == 0 )) {
					#line 528 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				...
				#line 530 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				double best = global::Math.POSITIVE_INFINITY;
				int bestMethod = 0;
				{
					#line 532 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					int _g3 = 0;
					#line 532 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					while (( _g3 < methodLength )){
						#line 532 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						int i3 = _g3++;
						#line 534 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						if (( rates[i3] < best )) {
							#line 536 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							bestMethod = i3;
				...
				#line 541 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				methods[0] = methods[bestMethod];
				global::System.Reflection.ParameterInfo[] params1 = methods[0].GetParameters();
				{
					#line 543 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					int _g12 = 0;
					#line 543 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					...
					while (( _g12 < _g4 )){
						#line 543 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						int i4 = _g12++;
						#line 545 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						...
						if (strParam1.StartsWith("haxe.lang.Null")) {
							#line 549 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							oargs[i4] = global::haxe.lang.Runtime.mkNullable(oargs[i4], param1);
						}
						 else {
							#line 550 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							if ((((global::System.Type) (typeof(global::System.IConvertible)) )).IsAssignableFrom(((global::System.Type) (param1) ))) {
								#line 551 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
								if (global::haxe.lang.Runtime.eq(oargs[i4], default(object))) {
									#line 552 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
									if (param1.IsValueType) {
										#line 553 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
										oargs[i4] = global::System.Activator.CreateInstance(((global::System.Type) (param1) ));
									}
									
								}
								 else {
									#line 555 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				...
				#line 560 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( methods[0].ContainsGenericParameters && ( methods[0] is global::System.Reflection.MethodInfo ) )) {
					#line 562 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					...
					{
						#line 564 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						int _g13 = 0;
						#line 564 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						...
						while (( _g13 < _g5 )){
							#line 564 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							int i5 = _g13++;
							#line 566 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
							tgs[i5] = typeof(object);
						}
						
					}
					
					#line 568 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				...
				#line 573 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
		...
		public static   object unbox(object dyn){
			unchecked {
				#line 586 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( ( ! (global::haxe.lang.Runtime.eq(dyn, default(object))) ) && (global::haxe.lang.Runtime.concat(global::Std.@string(global::cs.Lib.nativeType(dyn)), "")).StartsWith("haxe.lang.Null") )) {
					#line 588 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					return ((object) (global::haxe.lang.Runtime.callField(dyn, "toDynamic", 1705629508, default(global::Array))) );
				}
				 else {
					#line 590 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					return dyn;
				}
		...
		public static   string toString(object obj){
			unchecked {
				#line 722 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (global::haxe.lang.Runtime.eq(obj, default(object))) {
					#line 723 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					return default(string);
				}
				
				#line 724 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				if (( obj is bool )) {
					#line 725 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
					if (global::haxe.lang.Runtime.toBool((obj))) {
						#line 726 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						return "true";
					}
					 else {
						#line 728 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
						return "false";
					}
					
				}
				
				#line 730 "F:\\HaxeToolkit\\haxe\\std\\cs\\internal\\Runtime.hx"
				return obj.ToString();
			}
			#line default
		}
