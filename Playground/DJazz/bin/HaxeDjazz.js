...
Main.prototype = {
	...
	,onWorkerMessage: function(e) {
		haxe.Log.trace("worker " + Std.string(Type.getClass(e)),{ fileName : "Main.hx", lineNumber : 129, className : "Main", methodName : "onWorkerMessage"});
		var frameSize = 1024;
		...
		if(e.data.frames != null) {
			...
			haxe.Log.trace("WORKER:",{ fileName : "Main.hx", lineNumber : 158, className : "Main", methodName : "onWorkerMessage", customParams : [e.data]});
	...
	,onDecode: function(buffer) {
		...
		this.stopPlayback();
		haxe.Log.trace("Audio data decoded" + this.currentBuffer.length,{ fileName : "Main.hx", lineNumber : 168, className : "Main", methodName : "onDecode"});
	...
	,loadfile: function(musicfile) {
		...
		haxe.Log.trace("Downloading audio...",{ fileName : "Main.hx", lineNumber : 208, className : "Main", methodName : "loadfile"});
		this.statusSpan.textContent = "Downloading...";
		loader.addEventListener("load",function(_) {
			haxe.Log.trace("Decoding audio...",{ fileName : "Main.hx", lineNumber : 211, className : "Main", methodName : "loadfile"});
			_g.statusSpan.textContent = "Decoding audio...";
			_g.customAudio.disabled = true;
			_g.sampleSong.innerHTML = "";
			_g.acx.decodeAudioData(loader.response,$bind(_g,_g.onDecode),function(buffer) {
