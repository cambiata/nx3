...
var Main = function() {
	var _g = this;
	this.nscore2 = new nx3.NScore([new nx3.NBar([new nx3.NPart([new nx3.NVoice([new nx3.NNote(null,[new nx3.NHead(null,0)]),new nx3.NNote(null,[new nx3.NHead(null,0)]),new nx3.NNote(null,[new nx3.NHead(null,0)]),new nx3.NNote(null,[new nx3.NHead(null,4,nx3.ESign.Flat)],nx3.ENoteVal.Nv16),new nx3.NNote(null,[new nx3.NHead(null,3)],nx3.ENoteVal.Nv16),new nx3.NNote(null,[new nx3.NHead(null,1,nx3.ESign.Flat)],nx3.ENoteVal.Nv16),new nx3.NNote(null,[new nx3.NHead(null,4,nx3.ESign.Flat)],nx3.ENoteVal.Nv16)])])]),new nx3.NBar([new nx3.NPart([new nx3.NVoice([new nx3.NNote(null,[new nx3.NHead(null,4,nx3.ESign.Flat)],nx3.ENoteVal.Nv4),new nx3.NNote(null,[new nx3.NHead(null,4,nx3.ESign.Flat)],nx3.ENoteVal.Nv4),new nx3.NNote(null,[new nx3.NHead(null,0)]),new nx3.NNote(null,[new nx3.NHead(null,0)])])])])]);
	this.nscore1 = nx3.test.TestItemsBach.scoreBachSinfonia4();
	var scaling = nx3.render.scaling.Scaling.NORMAL;
	var pscore1 = new nx3.PScore(this.nscore1);
	...
	var div = nx3.utils.JsSvgTools.createDivElement(svgXml);
	...
	canvas.addEventListener("mousemove",function(e) {
		...
		_g.drawingTools.drawColumnFromTime(time * 30);
	});
	this.setupUI();
};
Main.__name__ = true;
...
Main.prototype = {
	setupUI: function() {
		...
		window.document.getElementById("btn1").addEventListener("click",function(_) {
			...
			this1(function(wav16) {
				...
				_g.drawingTools.drawColumnFromTime(0);
		...
		window.document.getElementById("btn2").addEventListener("click",function(_1) {
			...
			this2(function(wav161) {
				...
				(audiotools.sound.Wav16SoundManager.instance == null?audiotools.sound.Wav16SoundManager.instance = new audiotools.sound.Wav16SoundManager():audiotools.sound.Wav16SoundManager.instance).initSound(wav161,$bind(_g,_g.playCallback),_g.nscore1.uuid + "120");
				(audiotools.sound.Wav16SoundManager.instance == null?audiotools.sound.Wav16SoundManager.instance = new audiotools.sound.Wav16SoundManager():audiotools.sound.Wav16SoundManager.instance).start(0);
				_g.drawingTools.drawColumnFromTime(0);
			});
		});
	...
	,playCallback: function(key,pos) {
		if(pos == null) window.document.getElementById("label").textContent = "null"; else window.document.getElementById("label").textContent = "" + pos;
...
nx3.PSystemTools = function(system) {
	this.system = system;
};
nx3.PSystemTools.__name__ = true;
nx3.PSystemTools.prototype = {
	getSysbarsColumns: function() {
		if(this.sysbarColumns != null) return this.sysbarColumns;
		this.sysbarColumns = new haxe.ds.ObjectMap();
		var _g = 0;
		var _g1 = this.system.getSystembars();
		while(_g < _g1.length) {
			var sysbar = _g1[_g];
	...
	,getColumnsPointH: function() {
		...
		while(_g < _g1.length) {
			...
			++_g;
			var sysbar;
			var this1 = this.getSysbarsColumns();
...
nx3.utils.JsSvgTools = function() { };
nx3.utils.JsSvgTools.__name__ = true;
nx3.utils.JsSvgTools.createDivElement = function(svgXml,divId,createCanvas) {
	if(createCanvas == null) createCanvas = true;
	if(divId == null) divId = "";
	var div;
	...
	if(divId != "") div.id = divId; else div.id = svg.id + "-wrapper";
