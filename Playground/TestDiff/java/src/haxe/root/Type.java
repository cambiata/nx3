...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__Type(haxe.root.Type __temp_me11)
	{
		{
		}
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar241 = (name);
			...
			switch (__temp_hash243)
			{
				...
				{
					if (( (( ( __temp_hash243 == -672261858 ) && __temp_svar241.equals("Integer") )) || __temp_svar241.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar241.equals("Object")) 
					{
						__temp_executeDef242 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash243 == 2052876273 ) && __temp_svar241.equals("Double") )) || __temp_svar241.equals("double") )) 
					{
						__temp_executeDef242 = false;
						return "Float";
					}
