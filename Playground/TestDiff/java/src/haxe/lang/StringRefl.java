...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar398 = (f);
			int __temp_hash400 = __temp_svar398.hashCode();
			boolean __temp_executeDef399 = true;
			switch (__temp_hash400)
			{
				case -1106363674:
				{
					if (__temp_svar398.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash400 == 530542161 ) && __temp_svar398.equals("substring") )) || ( (( ( __temp_hash400 == -891529231 ) && __temp_svar398.equals("substr") )) || ( (( ( __temp_hash400 == 109648666 ) && __temp_svar398.equals("split") )) || ( (( ( __temp_hash400 == -467511597 ) && __temp_svar398.equals("lastIndexOf") )) || ( (( ( __temp_hash400 == 1943291465 ) && __temp_svar398.equals("indexOf") )) || ( (( ( __temp_hash400 == 397153782 ) && __temp_svar398.equals("charCodeAt") )) || ( (( ( __temp_hash400 == -1361633751 ) && __temp_svar398.equals("charAt") )) || ( (( ( __temp_hash400 == -1137582698 ) && __temp_svar398.equals("toLowerCase") )) || __temp_svar398.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef399 = false;
