...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public static  <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me41)
	{
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt337 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt337 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv338 = false;
					if ( ! (__temp_stmt337) ) 
					{
						__temp_boolv338 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt336 = ( __temp_stmt337 || __temp_boolv338 );
					if ( ! ((__temp_stmt336)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt342 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt342 = ( v == 0 );
				}
				
				boolean __temp_boolv341 =  ! (__temp_stmt342) ;
				boolean __temp_boolv340 = false;
				if (__temp_boolv341) 
				{
					__temp_boolv340 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt339 = ( __temp_boolv341 && __temp_boolv340 );
				if (__temp_stmt339) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt343 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt343 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt343) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv346 = ( i < nBuckets );
						boolean __temp_boolv345 = false;
						if (__temp_boolv346) 
						{
							boolean __temp_stmt347 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt347 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv345 =  ! (__temp_stmt347) ;
						}
						
						boolean __temp_stmt344 = ( __temp_boolv346 && __temp_boolv345 );
						if (__temp_stmt344) 
						{
							{
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl348 = new haxe.ds.StringMap_keys_356__Fun<T>(((haxe.root.Array<java.lang.Object>) (len) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			haxe.lang.Function __temp_odecl349 = new haxe.ds.StringMap_keys_367__Fun<T>(((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (i) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl348, __temp_odecl349}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	{
		{
			boolean __temp_executeDef350 = true;
	...
	{
		{
			boolean __temp_executeDef351 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef352 = true;
			switch (field.hashCode())
			{
				case 3288564:
				{
	...
	{
		{
			boolean __temp_executeDef353 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef354 = true;
			switch (field.hashCode())
			{
				case 3288564:
				{
