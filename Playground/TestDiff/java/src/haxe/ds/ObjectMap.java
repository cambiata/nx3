...
public  class ObjectMap<K, V> extends haxe.lang.HxObject implements haxe.root.IMap<K, V>
{
	...
	public static  <K_c, V_c> void __hx_ctor_haxe_ds_ObjectMap(haxe.ds.ObjectMap<K_c, V_c> __temp_me40)
	{
	...
	public   void set(K key, V value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt318 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt318 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv319 = false;
					if ( ! (__temp_stmt318) ) 
					{
						__temp_boolv319 = ( ( flag == k ) && keys[i].equals(key) );
					}
					
					boolean __temp_stmt317 = ( __temp_stmt318 || __temp_boolv319 );
					if ( ! ((__temp_stmt317)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(K key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt323 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt323 = ( v == 0 );
				}
				
				boolean __temp_boolv322 =  ! (__temp_stmt323) ;
				boolean __temp_boolv321 = false;
				if (__temp_boolv322) 
				{
					__temp_boolv321 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (keys[i].equals(key))  ));
				}
				
				boolean __temp_stmt320 = ( __temp_boolv322 && __temp_boolv321 );
				if (__temp_stmt320) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k1 = 0;
				boolean __temp_stmt324 = false;
				{
					int v1 = k1 = hashes[j];
					__temp_stmt324 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt324) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k1;
						boolean __temp_boolv327 = ( i < nBuckets );
						boolean __temp_boolv326 = false;
						if (__temp_boolv327) 
						{
							boolean __temp_stmt328 = false;
							{
								int v2 = k1 = hashes[i];
								__temp_stmt328 = ( (( v2 & -2 )) == 0 );
							}
							
							__temp_boolv326 =  ! (__temp_stmt328) ;
						}
						
						boolean __temp_stmt325 = ( __temp_boolv327 && __temp_boolv326 );
						if (__temp_stmt325) 
						{
							{
								K tmp = _keys[i];
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl329 = new haxe.ds.ObjectMap_keys_356__Fun<V, K>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ));
			haxe.lang.Function __temp_odecl330 = new haxe.ds.ObjectMap_keys_367__Fun<V, K>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.ObjectMap>) (_g1) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl329, __temp_odecl330}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	{
		{
			boolean __temp_executeDef331 = true;
	...
	{
		{
			boolean __temp_executeDef332 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef333 = true;
			switch (field.hashCode())
			{
				case 3288564:
				{
	...
	{
		{
			boolean __temp_executeDef334 = true;
			switch (field.hashCode())
			{
				case 1005083856:
				{
	...
	{
		{
			boolean __temp_executeDef335 = true;
			switch (field.hashCode())
			{
				case 3288564:
				{
