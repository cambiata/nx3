...
public  class ArrayTools extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_cx_ArrayTools(cx.ArrayTools __temp_me14)
	{
		{
		}
	...
	public static  <T> haxe.root.Array<T> fromIterator(java.lang.Object it)
	{
		...
		{
			java.lang.Object __temp_iterator189 = it;
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator189, "hasNext", null)))
			{
				T v = ((T) (haxe.lang.Runtime.callField(__temp_iterator189, "next", null)) );
				result.push(v);
			}
	...
	{
		int __temp_step13 = ( (( step == null )) ? (((int) (1) )) : (((int) (haxe.lang.Runtime.toInt(step)) )) );
		if (( null == stop )) 
		{
			stop = start;
			start = 0;
		...
		if (( ( ((double) ((( ((int) (haxe.lang.Runtime.toInt(stop)) ) - ((int) (start) ) ))) ) / __temp_step13 ) == java.lang.Double.POSITIVE_INFINITY )) 
		{
		...
		if (( __temp_step13 < 0 )) 
		{
			while (( haxe.lang.Runtime.compare((j = ( start + ( __temp_step13 *  ++ i ) )), stop) > 0 ))
			{
				range.push(j);
			}
