...
public  class PBaseRectCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PBaseRectCalculator(nx3.PBaseRectCalculator __temp_me79, nx3.PNote note)
	{
		__temp_me79.note = note;
	}
	...
	{
		{
			...
			switch (haxe.root.Type.enumIndex(_g))
			{
				...
				case 4:
				{
					...
					nx3.geom.Rectangle __temp_stmt452 = null;
					{
						haxe.root.Array<nx3.geom.Rectangle> array = this.note.getHeadsRects();
						__temp_stmt452 = array.__get(0);
					}
					
					return __temp_stmt452.clone();
				}
	...
	{
		{
			boolean __temp_executeDef454 = true;
			switch (field.hashCode())
			{
				case 356336075:
				{
