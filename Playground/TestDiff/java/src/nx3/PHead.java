...
public  class PHead extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PHead(nx3.PHead __temp_me95, nx3.NHead nhead)
	{
		__temp_me95.nhead = nhead;
	}
	...
	{
		{
			boolean __temp_executeDef520 = true;
	...
	{
		{
			boolean __temp_executeDef521 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
