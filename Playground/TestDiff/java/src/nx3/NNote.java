...
public  class NNote extends haxe.lang.HxObject implements hxlazy.Lazy
{
	...
	public static   void __hx_ctor_nx3_NNote(nx3.NNote __temp_me63, nx3.ENoteType type, haxe.root.Array<nx3.NHead> heads, nx3.ENoteVal value, nx3.EDirectionUAD direction)
	{
		if (( type == null )) 
		{
			if (( heads != null )) 
		...
		if (( type == null )) 
		{
			__temp_me63.type = nx3.ENoteType.Note(heads, null, null, null);
		}
		 else 
		{
			__temp_me63.type = type;
		}
		
		if (( value == null )) 
		{
			__temp_me63.value = nx3.ENoteVal.Nv4;
		}
		 else 
		{
			__temp_me63.value = value;
		}
		
		if (( direction == null )) 
		{
			__temp_me63.direction = nx3.EDirectionUAD.Auto;
		}
		 else 
		{
			__temp_me63.direction = direction;
		}
		...
		
		{
			...
			switch (haxe.root.Type.enumIndex(_g))
			{
				case 0:
				{
					...
					{
						nheads.sort(( (( nx3.NNote_get_nheads_51__Fun.__hx_current != null )) ? (nx3.NNote_get_nheads_51__Fun.__hx_current) : (nx3.NNote_get_nheads_51__Fun.__hx_current = ((nx3.NNote_get_nheads_51__Fun) (new nx3.NNote_get_nheads_51__Fun()) )) ));
						this.nheads_ = nheads;
					}
	...
	public   haxe.root.Array<java.lang.Object> get_headLevels()
	{
		...
		return this.__lazyheadLevels = ((haxe.root.Array<java.lang.Object>) (((haxe.root.Array) (haxe.root.Lambda.array(((haxe.root.List<java.lang.Object>) (((haxe.root.List) (haxe.root.Lambda.map(this, ( (( nx3.NNote_get_headLevels_66__Fun.__hx_current != null )) ? (nx3.NNote_get_headLevels_66__Fun.__hx_current) : (nx3.NNote_get_headLevels_66__Fun.__hx_current = ((nx3.NNote_get_headLevels_66__Fun) (new nx3.NNote_get_headLevels_66__Fun()) )) ))) )) ))) )) );
	}
	...
	public   haxe.root.Array<nx3.ETie> get_ties()
	{
		...
		return this.__lazyties = ((haxe.root.Array<nx3.ETie>) (((haxe.root.Array) (haxe.root.Lambda.array(((haxe.root.List<nx3.ETie>) (((haxe.root.List) (((haxe.root.List<nx3.NHead>) (((haxe.root.List) (haxe.root.Lambda.filter(this, ( (( nx3.NNote_get_ties_69__Fun.__hx_current != null )) ? (nx3.NNote_get_ties_69__Fun.__hx_current) : (nx3.NNote_get_ties_69__Fun.__hx_current = ((nx3.NNote_get_ties_69__Fun) (new nx3.NNote_get_ties_69__Fun()) )) ))) )) ).map(( (( nx3.NNote_get_ties_69__Fun_0.__hx_current != null )) ? (nx3.NNote_get_ties_69__Fun_0.__hx_current) : (nx3.NNote_get_ties_69__Fun_0.__hx_current = ((nx3.NNote_get_ties_69__Fun_0) (new nx3.NNote_get_ties_69__Fun_0()) )) ))) )) ))) )) );
	}
	...
	{
		{
			boolean __temp_executeDef419 = true;
			switch (field.hashCode())
			{
				case 1976672556:
				{
