...
public  class PNoteHeadsRectsPausesCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PNoteHeadsRectsPausesCalculator(nx3.PNoteHeadsRectsPausesCalculator __temp_me101, nx3.PNote vnote)
	{
		__temp_me101.vnote = vnote;
	}
	...
	{
		{
			boolean __temp_executeDef544 = true;
