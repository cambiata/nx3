...
public  class NVoice extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_NVoice(nx3.NVoice __temp_me66, haxe.root.Array<nx3.NNote> notes, nx3.EVoiceType type, nx3.EDirectionUAD direction)
	{
		if (( ( notes == null ) || ( notes.length == 0 ) )) 
		{
			__temp_me66.nnotes = new haxe.root.Array<nx3.NNote>(new nx3.NNote[]{});
			__temp_me66.type = nx3.EVoiceType.Barpause(0);
		}
		 else 
		{
			__temp_me66.nnotes = notes;
			if (( type != null )) 
			{
				__temp_me66.type = type;
			}
			 else 
			{
				__temp_me66.type = nx3.EVoiceType.Normal;
			}
		...
		if (( direction != null )) 
		{
			__temp_me66.direction = direction;
		}
		 else 
		{
			__temp_me66.direction = nx3.EDirectionUAD.Auto;
		}
	...
	{
		{
			boolean __temp_executeDef432 = true;
			switch (field.hashCode())
			{
				case 1959846858:
				{
	...
	{
		{
			boolean __temp_executeDef433 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef434 = true;
			switch (field.hashCode())
			{
				case 1959846858:
				{
