...
public  class PScore extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PScore(nx3.PScore __temp_me107, nx3.NScore nscore)
	{
		__temp_me107.prevSystemwidth = ((double) (0) );
		__temp_me107.nscore = nscore;
	}
	...
	public   haxe.root.Array<nx3.PSystem> getSystems(double systemwidth)
	{
		...
		
		{
			...
			while (( _g2 < _g11.length ))
			{
				...
				nx3.PSystem __temp_stmt565 = null;
				{
					haxe.root.Array<nx3.PSystem> array = this.systems;
					__temp_stmt565 = array.__get(( array.length - 1 ));
				}
				
				if (( system1 != __temp_stmt565 )) 
				{
					ifMoreThan = ((double) (0) );
				}
				 else 
