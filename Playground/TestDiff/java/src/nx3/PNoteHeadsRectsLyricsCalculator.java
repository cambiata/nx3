...
public  class PNoteHeadsRectsLyricsCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PNoteHeadsRectsLyricsCalculator(nx3.PNoteHeadsRectsLyricsCalculator __temp_me100, nx3.PNote note, java.lang.String text, java.lang.Object font)
	{
		__temp_me100.note = note;
		__temp_me100.text = text;
		__temp_me100.font = font;
	}
	...
	{
		{
			boolean __temp_executeDef539 = true;
	...
	{
		{
			boolean __temp_executeDef542 = true;
			switch (field.hashCode())
			{
				case 3148879:
				{
