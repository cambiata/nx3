...
public  class PComplex extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PComplex(nx3.PComplex __temp_me89, nx3.PPart part, haxe.root.Array<nx3.PNote> notes, int valueposition)
	{
		__temp_me89.part = part;
		if (( notes.length > 2 )) 
		{
			throw haxe.lang.HaxeException.wrap("PComplex nr of PNote(s) limited to max 2 - for now");
		}
		
		__temp_me89.notes = notes;
		{
			int _g = 0;
			haxe.root.Array<nx3.PNote> _g1 = __temp_me89.notes;
			while (( _g < _g1.length ))
			{
				nx3.PNote note = _g1.__get(_g);
				 ++ _g;
				note.complex = __temp_me89;
			}
	...
	{
		nx3.PNote __temp_stmt496 = null;
		{
			haxe.root.Array<nx3.PNote> array = this.getNotes();
			__temp_stmt496 = array.__get(0);
		}
		
		if (( note == __temp_stmt496 )) 
		{
			return ((double) (0) );
		}
		...
		nx3.PNote __temp_stmt497 = null;
		{
			haxe.root.Array<nx3.PNote> array1 = this.getNotes();
			__temp_stmt497 = array1.__get(1);
		}
		
		nx3.PNoteOffsetCalculator __temp_stmt498 = new nx3.PNoteOffsetCalculator(((nx3.PComplex) (this) ));
		this.secondoffset = __temp_stmt498.getNoteOffset(__temp_stmt497);
		return ((double) (haxe.lang.Runtime.toDouble(this.secondoffset)) );
	}
	...
	{
		{
			boolean __temp_executeDef501 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
	...
	{
		{
			boolean __temp_executeDef503 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
