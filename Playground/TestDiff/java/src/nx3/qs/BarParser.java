...
public  class BarParser extends nx3.qs.BaseParser
{
	...
	public static   void __hx_ctor_nx3_qs_BarParser(nx3.qs.BarParser __temp_me164, nx3.qs.QuickSyntaxParser parser)
	{
		nx3.qs.BaseParser.__hx_ctor_nx3_qs_BaseParser(__temp_me164, parser);
		__temp_me164.barIndex = 0;
		__temp_me164.partIndex = 0;
		__temp_me164.voiceIndex = 0;
	}
	...
	{
		{
			int __temp_hash662 = field.hashCode();
			boolean __temp_executeDef661 = true;
			switch (__temp_hash662)
			{
				case -2111738369:case -1760504437:case -1605705217:
				{
					if (( (( ( __temp_hash662 == -2111738369 ) && field.equals("recieveEvent") )) || ( (( ( __temp_hash662 == -1760504437 ) && field.equals("tokenFinished") )) || field.equals("createFunctions") ) )) 
					{
