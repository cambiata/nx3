...
public  class NoteParser_createFunctions_63__Fun extends haxe.lang.Function
{
	public    NoteParser_createFunctions_63__Fun(haxe.root.Array<nx3.qs.NoteParser> _g)
	{
		super(1, 0);
		this._g = _g;
	}
