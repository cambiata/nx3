...
public  class LyricsParser_createFunctions_29__Fun extends haxe.lang.Function
{
	public    LyricsParser_createFunctions_29__Fun(haxe.root.Array<nx3.qs.LyricsParser> _g)
	{
		super(1, 0);
		this._g = _g;
	}
