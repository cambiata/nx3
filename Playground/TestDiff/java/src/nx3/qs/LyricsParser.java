...
public  class LyricsParser extends nx3.qs.BaseParser
{
	...
	public static   void __hx_ctor_nx3_qs_LyricsParser(nx3.qs.LyricsParser __temp_me165, nx3.qs.QuickSyntaxParser builder)
	{
		nx3.qs.BaseParser.__hx_ctor_nx3_qs_BaseParser(__temp_me165, builder);
		__temp_me165.notevalue = nx3.ENoteVal.Nv4;
		__temp_me165.flagWord = false;
	}
