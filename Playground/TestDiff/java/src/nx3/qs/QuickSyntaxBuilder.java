...
public  class QuickSyntaxBuilder extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_qs_QuickSyntaxBuilder(nx3.qs.QuickSyntaxBuilder __temp_me169, haxe.ds.StringMap<haxe.root.Array> qsnotes)
	{
		__temp_me169.qsnotes = qsnotes;
	}
	...
	public   haxe.root.Array<nx3.NBar> getNBars()
	{
		...
		int voiceMax = 0;
		{
			java.lang.Object __temp_iterator201 = this.qsnotes.keys();
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator201, "hasNext", null)))
			{
				java.lang.String key = haxe.lang.Runtime.toString(haxe.lang.Runtime.callField(__temp_iterator201, "next", null));
