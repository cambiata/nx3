...
public  class BaseParser extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_qs_BaseParser(nx3.qs.BaseParser __temp_me163, nx3.qs.QuickSyntaxParser builder)
	{
		__temp_me163.builder = builder;
		__temp_me163.functions = new haxe.ds.StringMap<haxe.lang.Function>();
		__temp_me163.createFunctions();
	}
