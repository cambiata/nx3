...
public  class QNote extends nx3.NNote
{
	...
	public static   void __hx_ctor_nx3_QNote(nx3.QNote __temp_me128, java.lang.Object headLevel, haxe.root.Array<java.lang.Object> headLevels, nx3.NHead head, haxe.root.Array<nx3.NHead> heads, nx3.ENoteVal value, java.lang.String signs, nx3.EDirectionUAD direction)
	{
		if (( signs == null )) 
		{
			signs = "";
			...
			int i = 0;
			{
				...
				while (( _g < headLevels.length ))
				{
					int level = ((int) (haxe.lang.Runtime.toInt(headLevels.__get(_g))) );
					 ++ _g;
					heads.push(new nx3.NHead(((nx3.EHeadType) (null) ), ((java.lang.Object) (level) ), ((nx3.ESign) (__temp_me128.getSign(aSigns.__get(i++))) ), ((nx3.ETie) (null) ), ((nx3.ETie) (null) )));
				}
		...
		nx3.NNote.__hx_ctor_nx3_NNote(__temp_me128, null, heads, value, direction);
	}
	...
	{
		{
			java.lang.String __temp_svar631 = (val);
			int __temp_hash633 = __temp_svar631.hashCode();
			boolean __temp_executeDef632 = true;
			switch (__temp_hash633)
			{
				case 35:
				{
					if (__temp_svar631.equals("#")) 
					{
				...
				case 110:case 78:
				{
					if (( (( ( __temp_hash633 == 110 ) && __temp_svar631.equals("n") )) || __temp_svar631.equals("N") )) 
					{
						__temp_executeDef632 = false;
