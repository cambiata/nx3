...
public  class PBar extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PBar(nx3.PBar __temp_me69, nx3.NBar nbar)
	{
		__temp_me69.stretchwidth = ((double) (0) );
		__temp_me69._keys = null;
		__temp_me69._clefs = null;
		__temp_me69.nbar = nbar;
		__temp_me69.value = 0;
	}
	...
	{
		{
			boolean __temp_executeDef439 = true;
			switch (field.hashCode())
			{
				case -1675713851:
				{
	...
	{
		{
			boolean __temp_executeDef440 = true;
			switch (field.hashCode())
			{
				case -299886693:
				{
	...
	{
		{
			boolean __temp_executeDef442 = true;
			switch (field.hashCode())
			{
				case -299886693:
				{
