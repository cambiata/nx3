...
public  class PBeamgroupDirectionCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PBeamgroupDirectionCalculator(nx3.PBeamgroupDirectionCalculator __temp_me82, nx3.PBeamgroup beamgroup)
	{
		__temp_me82.beamgroup = beamgroup;
	}
	...
	{
		{
			boolean __temp_executeDef466 = true;
			switch (field.hashCode())
			{
				case 757123232:
				{
	...
	{
		{
			boolean __temp_executeDef468 = true;
			switch (field.hashCode())
			{
				case 757123232:
				{
