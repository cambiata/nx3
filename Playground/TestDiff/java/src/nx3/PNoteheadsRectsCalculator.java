...
public  class PNoteheadsRectsCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PNoteheadsRectsCalculator(nx3.PNoteheadsRectsCalculator __temp_me103, nx3.PNote note)
	{
		__temp_me103.note = note;
	}
	...
	{
		{
			boolean __temp_executeDef551 = true;
	...
	{
		{
			boolean __temp_executeDef553 = true;
			switch (field.hashCode())
			{
				case 2051530802:
				{
