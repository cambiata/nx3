...
public  class ETimeUtils extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_ETimeUtils(nx3.ETimeUtils __temp_me58)
	{
		{
		}
	...
	public static   nx3.ETime fromString(java.lang.String str)
	{
		...
		{
			java.lang.String __temp_svar403 = (str);
			boolean __temp_executeDef404 = true;
			switch (__temp_svar403.hashCode())
			{
				case 51479:
				{
					if (__temp_svar403.equals("4/2")) 
					{
				...
				case 1927126116:
				{
					if (__temp_svar403.equals("AllaBreve")) 
					{
						__temp_executeDef404 = false;
