...
public  class PSystembarMeasurements extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PSystembarMeasurements(nx3.PSystembarMeasurements __temp_me117, nx3.PBar bar)
	{
		__temp_me117.barlineWidth = ((double) (0) );
		__temp_me117.cautTimeWidth = ((double) (0) );
		__temp_me117.cautKeyWidth = ((double) (0) );
		__temp_me117.cautClefWidth = ((double) (0) );
		__temp_me117.contentWidth = ((double) (0) );
		__temp_me117.contentXZero = ((double) (0) );
		__temp_me117.leftContentMarginWidth = ((double) (0) );
		__temp_me117.timeWidth = ((double) (0) );
		__temp_me117.keyWidth = ((double) (0) );
		__temp_me117.clefWidth = ((double) (0) );
		__temp_me117.ackoladeWidth = ((double) (0) );
		__temp_me117.bar = bar;
	}
