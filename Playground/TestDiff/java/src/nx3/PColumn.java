...
public  class PColumn extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PColumn(nx3.PColumn __temp_me84, nx3.PBar bar, haxe.root.Array<nx3.PComplex> complexes, int valueposition, int value)
	{
		__temp_me84.allottedDistance = ((double) (0) );
		__temp_me84.bar = bar;
		__temp_me84.complexes = complexes;
		__temp_me84.valueposition = valueposition;
		__temp_me84.value = value;
		__temp_me84.mposition = 0.0;
		__temp_me84.mdistanceBenefit = 0;
	}
	...
	{
		nx3.PColumn __temp_stmt478 = null;
		{
			haxe.root.Array<nx3.PColumn> array = this.bar.getColumns();
			__temp_stmt478 = array.__get(( array.length - 1 ));
		}
		
		if (( this == __temp_stmt478 )) 
		{
			return null;
		}
