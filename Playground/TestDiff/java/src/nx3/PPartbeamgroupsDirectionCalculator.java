...
public  class PPartbeamgroupsDirectionCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PPartbeamgroupsDirectionCalculator(nx3.PPartbeamgroupsDirectionCalculator __temp_me106, nx3.PPart ppart)
	{
		__temp_me106.ppart = ppart;
	}
	...
	{
		{
			boolean __temp_executeDef563 = true;
			switch (field.hashCode())
			{
				case 225756157:
				{
