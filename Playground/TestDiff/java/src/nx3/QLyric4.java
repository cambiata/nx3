...
public  class QLyric4 extends nx3.NNote
{
	...
	public static   void __hx_ctor_nx3_QLyric4(nx3.QLyric4 __temp_me140, java.lang.String text)
	{
		nx3.NNote.__hx_ctor_nx3_NNote(__temp_me140, nx3.ENoteType.Lyric(( (( text == null )) ? (haxe.lang.Runtime.toString("QLyric4")) : (text) ), null, null, null), null, nx3.ENoteVal.Nv4, null);
		if (( text == null )) 
		{
			text = "QLyric4";
		}
