...
public  class PSystemBarsGenerator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PSystemBarsGenerator(nx3.PSystemBarsGenerator __temp_me116, haxe.root.Array<nx3.PBar> bars, java.lang.Object systemConfig, java.lang.Object prevBarAttributes, double breakSystemwidth, nx3.IBarWidthCalculator barWidthCalculator)
	{
		__temp_me116.bars = bars;
		__temp_me116.systemConfig = systemConfig;
		__temp_me116.prevBarAttributes = prevBarAttributes;
		__temp_me116.breakSystemwidth = breakSystemwidth;
		__temp_me116.system = new nx3.PSystem();
		__temp_me116.barWidthCalculator = barWidthCalculator;
	}
	...
	{
		this.system.status = nx3.PSystemStatus.Ok;
		nx3.PSystemBar __temp_stmt597 = null;
		{
			haxe.root.Array<nx3.PSystemBar> array = this.system.getSystembars();
			__temp_stmt597 = array.__get(( array.length - 1 ));
		}
		
		nx3.PBar sysBar = __temp_stmt597.bar;
		nx3.PSystemBar __temp_stmt598 = null;
		{
			haxe.root.Array<nx3.PSystemBar> array1 = this.system.getSystembars();
			__temp_stmt598 = array1.__get(( array1.length - 1 ));
		}
		
		java.lang.Object sysBarAttributes = __temp_stmt598.actAttributes;
		nx3.PBar __temp_stmt599 = null;
		{
			haxe.root.Array<nx3.PBar> array2 = this.bars;
			__temp_stmt599 = array2.__get(( array2.length - 1 ));
		}
		
		if (( sysBar != __temp_stmt599 )) 
		{
			...
			if (( ( newClef || newKey ) || newTime )) 
			{
				...
				nx3.PSystemBar __temp_stmt600 = null;
				{
					haxe.root.Array<nx3.PSystemBar> array3 = this.system.getSystembars();
					__temp_stmt600 = array3.__get(( array3.length - 1 ));
				}
				
				nx3.PBarConfig sysBarConfig = __temp_stmt600.barConfig;
				nx3.PSystemBar __temp_stmt602 = null;
				{
					haxe.root.Array<nx3.PSystemBar> array4 = this.system.getSystembars();
					__temp_stmt602 = array4.__get(( array4.length - 1 ));
				}
				
				nx3.PSystembarMeasurements __temp_stmt601 = __temp_stmt602.getBarMeasurements();
				double sysBarWidth = __temp_stmt601.getTotalWidth();
				...
				{
					nx3.PSystemBar __temp_stmt603 = null;
					{
						haxe.root.Array<nx3.PSystemBar> array5 = this.system.getSystembars();
						__temp_stmt603 = array5.__get(( array5.length - 1 ));
					}
					
					__temp_stmt603.caAttributes = sysBarCautAttributes;
					nx3.PSystemBar __temp_stmt604 = null;
					{
						haxe.root.Array<nx3.PSystemBar> array6 = this.system.getSystembars();
						__temp_stmt604 = array6.__get(( array6.length - 1 ));
					}
					
					__temp_stmt604.barConfig = sysBarConfigWithCautions;
					double __temp_stmt605 = ( this.system.getWidth() - sysBarWidth );
					nx3.PSystemBar __temp_stmt608 = null;
					{
						haxe.root.Array<nx3.PSystemBar> array7 = this.system.getSystembars();
						__temp_stmt608 = array7.__get(( array7.length - 1 ));
					}
					
					nx3.PSystembarMeasurements __temp_stmt607 = __temp_stmt608.getBarMeasurements();
					double __temp_stmt606 = __temp_stmt607.getTotalWidth();
					this.system.width = ( __temp_stmt605 + __temp_stmt606 );
				}
				 else 
				{
	...
	public   java.lang.Object copyBarAttributes(java.lang.Object barAttributes)
	{
		...
		{
			haxe.root.Array<nx3.EClef> __temp_odecl609 = new haxe.root.Array<nx3.EClef>();
			haxe.root.Array<nx3.EKey> __temp_odecl610 = new haxe.root.Array<nx3.EKey>();
			result = new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"clefs", "keys", "time"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl609, __temp_odecl610, null}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
	...
	public   java.lang.Object getBarAttributes(nx3.PBar bar)
	{
		...
		java.lang.Object result = null;
		{
			haxe.root.Array<nx3.EClef> __temp_odecl611 = bar.get_clefs().copy();
			haxe.root.Array<nx3.EKey> __temp_odecl612 = bar.get_keys().copy();
			result = new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"clefs", "keys", "time"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl611, __temp_odecl612, time}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
