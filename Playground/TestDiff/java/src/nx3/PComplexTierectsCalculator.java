...
public  class PComplexTierectsCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PComplexTierectsCalculator(nx3.PComplexTierectsCalculator __temp_me94, nx3.PComplex complex)
	{
		__temp_me94.complex = complex;
	}
	...
	public   haxe.root.Array<nx3.geom.Rectangle> getTieRects()
	{
		...
		if (( nrofnotes == 2 )) 
		{
			nx3.PNote __temp_stmt512 = null;
			{
				haxe.root.Array<nx3.PNote> array2 = this.complex.getNotes();
				__temp_stmt512 = array2.__get(1);
			}
			
			secondties = __temp_stmt512.getTies();
		}
		 else 
		{
		...
		double tieheight = 1.6;
		{
			...
			while (( _g < _g1.length ))
			{
				...
				if (( head.nhead.tie != null )) 
				{
					...
					{
						boolean __temp_boolv515 = ( secondnote == null );
						boolean __temp_boolv514 = false;
						if (__temp_boolv515) 
						{
							nx3.PHead __temp_stmt516 = null;
							{
								haxe.root.Array<nx3.PHead> array3 = firstnote.get_heads();
								__temp_stmt516 = array3.__get(( array3.length - 1 ));
							}
							
							__temp_boolv514 = ( head == __temp_stmt516 );
						}
						
						boolean __temp_stmt513 = ( __temp_boolv515 && __temp_boolv514 );
						if (__temp_stmt513) 
						{
							direction = nx3.EDirectionUD.Down;
							adjusty = .5;
