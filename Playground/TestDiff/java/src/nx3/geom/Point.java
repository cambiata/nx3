...
public  class Point extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_geom_Point(nx3.geom.Point __temp_me156, java.lang.Object x, java.lang.Object y)
	{
		double __temp_y155 = ( (( y == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(y)) )) );
		double __temp_x154 = ( (( x == null )) ? (((double) (0) )) : (((double) (haxe.lang.Runtime.toDouble(x)) )) );
		__temp_me156.x = __temp_x154;
		__temp_me156.y = __temp_y155;
	}
