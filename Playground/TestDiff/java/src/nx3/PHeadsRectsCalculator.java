...
public  class PHeadsRectsCalculator extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_PHeadsRectsCalculator(nx3.PHeadsRectsCalculator __temp_me97, nx3.PNote note, nx3.EDirectionUD direction)
	{
		if (( direction != null )) 
		{
			__temp_me97.direction = direction;
		}
		 else 
		{
			__temp_me97.direction = note.getDirection();
		}
		
		__temp_me97.vheads = note.get_heads();
		__temp_me97.placements = new nx3.PHeadPlacementsCalculator(((haxe.root.Array<nx3.PHead>) (__temp_me97.vheads) ), ((nx3.EDirectionUD) (__temp_me97.direction) )).getHeadsPlacements();
		__temp_me97.notevalue = note.nnote.value;
	}
	...
	{
		{
			boolean __temp_executeDef530 = true;
			switch (field.hashCode())
			{
				case -1115837468:
				{
