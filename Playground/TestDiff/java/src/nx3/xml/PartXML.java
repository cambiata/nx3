...
public  class PartXML extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_xml_PartXML(nx3.xml.PartXML __temp_me176)
	{
		{
		}
	...
	public static   nx3.NPart fromXmlStr(java.lang.String xmlStr)
	{
		...
		{
			java.lang.Object __temp_iterator205 = xml.elements();
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator205, "hasNext", null)))
			{
				haxe.root.Xml v = ((haxe.root.Xml) (haxe.lang.Runtime.callField(__temp_iterator205, "next", null)) );
