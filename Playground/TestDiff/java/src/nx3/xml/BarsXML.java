...
public  class BarsXML extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_xml_BarsXML(nx3.xml.BarsXML __temp_me173)
	{
		{
		}
	...
	public static   haxe.root.Array<nx3.NBar> fromXmlStr(java.lang.String xmlStr)
	{
		...
		{
			java.lang.Object __temp_iterator203 = xml.elements();
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator203, "hasNext", null)))
			{
				haxe.root.Xml b = ((haxe.root.Xml) (haxe.lang.Runtime.callField(__temp_iterator203, "next", null)) );
