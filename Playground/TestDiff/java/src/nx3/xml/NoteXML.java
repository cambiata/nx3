...
public  class NoteXML extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_xml_NoteXML(nx3.xml.NoteXML __temp_me175)
	{
		{
		}
	...
	public static   nx3.NNote fromXmlStr(java.lang.String xmlStr)
	{
		...
		{
			java.lang.String __temp_svar684 = (xmlType);
			switch (__temp_svar684.hashCode())
			{
				case 3387378:
				{
					if (__temp_svar684.equals("note")) 
					{
						haxe.root.Array<nx3.NHead> heads = new haxe.root.Array<nx3.NHead>(new nx3.NHead[]{});
						{
							java.lang.Object __temp_iterator204 = xml.elementsNamed(nx3.xml.HeadXML.XHEAD);
							while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator204, "hasNext", null)))
							{
								haxe.root.Xml h = ((haxe.root.Xml) (haxe.lang.Runtime.callField(__temp_iterator204, "next", null)) );
				...
				case 103457887:
				{
					if (__temp_svar684.equals("lyric")) 
					{
				...
				case 106440182:
				{
					if (__temp_svar684.equals("pause")) 
					{
