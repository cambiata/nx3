...
public  class VoiceXML extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_nx3_xml_VoiceXML(nx3.xml.VoiceXML __temp_me177)
	{
		{
		}
	...
	public static   nx3.NVoice fromXmlStr(java.lang.String xmlStr)
	{
		...
		{
			java.lang.Object __temp_iterator206 = xml.elements();
			while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator206, "hasNext", null)))
			{
				haxe.root.Xml n = ((haxe.root.Xml) (haxe.lang.Runtime.callField(__temp_iterator206, "next", null)) );
