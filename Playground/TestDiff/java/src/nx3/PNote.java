...
public  class PNote extends haxe.lang.HxObject implements hxlazy.Lazy
{
	...
	public static   void __hx_ctor_nx3_PNote(nx3.PNote __temp_me98, nx3.NNote nnote)
	{
		__temp_me98.nnote = nnote;
	}
	...
	{
		{
			boolean __temp_executeDef532 = true;
			switch (field.hashCode())
			{
				case -1847961622:
				{
