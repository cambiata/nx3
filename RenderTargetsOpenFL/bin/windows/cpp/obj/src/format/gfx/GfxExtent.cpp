...
{
HX_STACK_FRAME("format.gfx.GfxExtent","new",0xe8f6c9e9,"format.gfx.GfxExtent.new","format/gfx/GfxExtent.hx",18,0x8292f529)
{
	HX_STACK_LINE(19)
	super::__construct();
	HX_STACK_LINE(20)
...
{
		HX_STACK_FRAME("format.gfx.GfxExtent","addExtent",0x2edf4d34,"format.gfx.GfxExtent.addExtent","format/gfx/GfxExtent.hx",24,0x8292f529)
		HX_STACK_THIS(this)
		...
		if (((this->extent == null()))){
			HX_STACK_LINE(27)
			this->extent = ::flash::geom::Rectangle_obj::__new(inX,inY,(int)0,(int)0);
			HX_STACK_LINE(28)
			return null();
		}
		HX_STACK_LINE(30)
...
bool GfxExtent_obj::geometryOnly( ){
	HX_STACK_FRAME("format.gfx.GfxExtent","geometryOnly",0xa3c10295,"format.gfx.GfxExtent.geometryOnly","format/gfx/GfxExtent.hx",37,0x8292f529)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
	return true;
}
...
{
		HX_STACK_FRAME("format.gfx.GfxExtent","moveTo",0x65f9b503,"format.gfx.GfxExtent.moveTo","format/gfx/GfxExtent.hx",40,0x8292f529)
		HX_STACK_THIS(this)
		HX_STACK_ARG(inX,"inX")
		HX_STACK_ARG(inY,"inY")
		HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("format.gfx.GfxExtent","lineTo",0x85ed28a6,"format.gfx.GfxExtent.lineTo","format/gfx/GfxExtent.hx",44,0x8292f529)
		HX_STACK_THIS(this)
		HX_STACK_ARG(inX,"inX")
		HX_STACK_ARG(inY,"inY")
		HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("format.gfx.GfxExtent","curveTo",0x58815213,"format.gfx.GfxExtent.curveTo","format/gfx/GfxExtent.hx",47,0x8292f529)
		HX_STACK_THIS(this)
...
Dynamic GfxExtent_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"extent") ) { extent=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
	}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flash::geom::Rectangle*/ ,(int)offsetof(GfxExtent_obj,extent),HX_CSTRING("extent")},
	{ hx::fsUnknown, 0, null()}
};
#endif
