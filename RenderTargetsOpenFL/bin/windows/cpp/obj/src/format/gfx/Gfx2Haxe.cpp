...
{
HX_STACK_FRAME("format.gfx.Gfx2Haxe","new",0x7e7ee51d,"format.gfx.Gfx2Haxe.new","format/gfx/Gfx2Haxe.hx",29,0xe4c483b1)
{
	HX_STACK_LINE(30)
	super::__construct();
	HX_STACK_LINE(31)
...
::String Gfx2Haxe_obj::f2a( Float f){
	HX_STACK_FRAME("format.gfx.Gfx2Haxe","f2a",0x7e78a692,"format.gfx.Gfx2Haxe.f2a","format/gfx/Gfx2Haxe.hx",35,0xe4c483b1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(36)
...
::String Gfx2Haxe_obj::newMatrix( ::flash::geom::Matrix m){
	HX_STACK_FRAME("format.gfx.Gfx2Haxe","newMatrix",0xca83c33e,"format.gfx.Gfx2Haxe.newMatrix","format/gfx/Gfx2Haxe.hx",43,0xe4c483b1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(44)
	::String _g = ((HX_CSTRING("new Matrix(") + this->f2a(m->a)) + HX_CSTRING(","));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(44)
	::String _g1 = ((_g + this->f2a(m->b)) + HX_CSTRING(","));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(44)
	::String _g2 = ((_g1 + this->f2a(m->c)) + HX_CSTRING(","));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(44)
	::String _g3 = ((_g2 + this->f2a(m->d)) + HX_CSTRING(","));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(44)
	::String _g4 = ((_g3 + this->f2a(m->tx)) + HX_CSTRING(","));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(44)
	return ((_g4 + this->f2a(m->ty)) + HX_CSTRING(")"));
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","beginGradientFill",0xa7ae41d9,"format.gfx.Gfx2Haxe.beginGradientFill","format/gfx/Gfx2Haxe.hx",49,0xe4c483b1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(grad,"grad")
		HX_STACK_LINE(50)
		::String _g = ((HX_CSTRING("g.beginGradientFill(") + ::Std_obj::string(grad->type)) + HX_CSTRING(","));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(50)
		::String _g1 = ((_g + ::Std_obj::string(grad->colors)) + HX_CSTRING(","));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(50)
		::String _g2 = ((_g1 + ::Std_obj::string(grad->alphas)) + HX_CSTRING(","));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(50)
		::String _g3 = ((_g2 + ::Std_obj::string(grad->ratios)) + HX_CSTRING(","));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(50)
		::String _g4 = ((_g3 + this->newMatrix(grad->matrix)) + HX_CSTRING(","));		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(50)
		::String _g5 = ((_g4 + ::Std_obj::string(grad->spread)) + HX_CSTRING(","));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(50)
		this->commands->push(((((_g5 + ::Std_obj::string(grad->interp)) + HX_CSTRING(",")) + grad->focus) + HX_CSTRING(");")));
	}
return null();
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","beginFill",0xdda06dc9,"format.gfx.Gfx2Haxe.beginFill","format/gfx/Gfx2Haxe.hx",57,0xe4c483b1)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","endFill",0x6be13f3b,"format.gfx.Gfx2Haxe.endFill","format/gfx/Gfx2Haxe.hx",59,0xe4c483b1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(59)
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","lineStyle",0x1c23691a,"format.gfx.Gfx2Haxe.lineStyle","format/gfx/Gfx2Haxe.hx",63,0xe4c483b1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(style,"style")
		HX_STACK_LINE(64)
		::String _g = ((((HX_CSTRING("g.lineStyle(") + this->f2a(style->thickness)) + HX_CSTRING(",")) + style->color) + HX_CSTRING(","));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(64)
		::String _g1 = ((_g + this->f2a(style->alpha)) + HX_CSTRING(","));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(64)
		::String _g2 = ((_g1 + ::Std_obj::string(style->pixelHinting)) + HX_CSTRING(","));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(64)
		::String _g3 = ((_g2 + ::Std_obj::string(style->scaleMode)) + HX_CSTRING(","));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(64)
		::String _g4 = ((_g3 + ::Std_obj::string(style->capsStyle)) + HX_CSTRING(","));		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(64)
		::String _g5 = ((_g4 + ::Std_obj::string(style->jointStyle)) + HX_CSTRING(","));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(64)
		this->commands->push((_g5 + this->f2a(style->miterLimit)));
	}
return null();
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","endLineStyle",0x86e79ce5,"format.gfx.Gfx2Haxe.endLineStyle","format/gfx/Gfx2Haxe.hx",69,0xe4c483b1)
		HX_STACK_THIS(this)
		HX_STACK_LINE(69)
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","moveTo",0xf093924f,"format.gfx.Gfx2Haxe.moveTo","format/gfx/Gfx2Haxe.hx",72,0xe4c483b1)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","lineTo",0x108705f2,"format.gfx.Gfx2Haxe.lineTo","format/gfx/Gfx2Haxe.hx",74,0xe4c483b1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(inX,"inX")
		HX_STACK_ARG(inY,"inY")
		HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("format.gfx.Gfx2Haxe","curveTo",0x14891747,"format.gfx.Gfx2Haxe.curveTo","format/gfx/Gfx2Haxe.hx",76,0xe4c483b1)
		HX_STACK_THIS(this)
