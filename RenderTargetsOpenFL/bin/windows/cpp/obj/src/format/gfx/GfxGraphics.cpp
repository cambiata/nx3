...
Void GfxGraphics_obj::__construct(::flash::display::Graphics inGraphics)
{
HX_STACK_FRAME("format.gfx.GfxGraphics","new",0x41bbd28a,"format.gfx.GfxGraphics.new","format/gfx/GfxGraphics.hx",30,0xfe340028)
...
hx::ObjectPtr< GfxGraphics_obj > GfxGraphics_obj::__new(::flash::display::Graphics inGraphics)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","beginGradientFill",0x7df2f406,"format.gfx.GfxGraphics.beginGradientFill","format/gfx/GfxGraphics.hx",37,0xfe340028)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","beginFill",0xc970aaf6,"format.gfx.GfxGraphics.beginFill","format/gfx/GfxGraphics.hx",40,0xfe340028)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","endFill",0x3745e728,"format.gfx.GfxGraphics.endFill","format/gfx/GfxGraphics.hx",41,0xfe340028)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","lineStyle",0x07f3a647,"format.gfx.GfxGraphics.lineStyle","format/gfx/GfxGraphics.hx",45,0xfe340028)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","endLineStyle",0x4cda19d8,"format.gfx.GfxGraphics.endLineStyle","format/gfx/GfxGraphics.hx",47,0xfe340028)
		HX_STACK_THIS(this)
		HX_STACK_LINE(47)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","moveTo",0xca750702,"format.gfx.GfxGraphics.moveTo","format/gfx/GfxGraphics.hx",49,0xfe340028)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","lineTo",0xea687aa5,"format.gfx.GfxGraphics.lineTo","format/gfx/GfxGraphics.hx",50,0xfe340028)
		HX_STACK_THIS(this)
		HX_STACK_ARG(inX,"inX")
		HX_STACK_ARG(inY,"inY")
		HX_STACK_LINE(50)
...
{
		HX_STACK_FRAME("format.gfx.GfxGraphics","curveTo",0xdfedbf34,"format.gfx.GfxGraphics.curveTo","format/gfx/GfxGraphics.hx",52,0xfe340028)
		HX_STACK_THIS(this)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flash::display::Graphics*/ ,(int)offsetof(GfxGraphics_obj,graphics),HX_CSTRING("graphics")},
	{ hx::fsUnknown, 0, null()}
};
#endif
