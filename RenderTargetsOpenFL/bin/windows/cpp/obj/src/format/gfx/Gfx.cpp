...
{
HX_STACK_FRAME("format.gfx.Gfx","new",0x9478571f,"format.gfx.Gfx.new","format/gfx/Gfx.hx",28,0xf24b1333)
{
}
;
	return null();
...
bool Gfx_obj::geometryOnly( ){
	HX_STACK_FRAME("format.gfx.Gfx","geometryOnly",0x93db1e9f,"format.gfx.Gfx.geometryOnly","format/gfx/Gfx.hx",29,0xf24b1333)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
	return false;
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx","size",0x58250122,"format.gfx.Gfx.size","format/gfx/Gfx.hx",30,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","beginGradientFill",0x1682735b,"format.gfx.Gfx.beginGradientFill","format/gfx/Gfx.hx",31,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","beginFill",0x16664d4b,"format.gfx.Gfx.beginFill","format/gfx/Gfx.hx",33,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","endFill",0x4748da3d,"format.gfx.Gfx.endFill","format/gfx/Gfx.hx",34,0xf24b1333)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx","lineStyle",0x54e9489c,"format.gfx.Gfx.lineStyle","format/gfx/Gfx.hx",36,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","endLineStyle",0x13c4daa3,"format.gfx.Gfx.endLineStyle","format/gfx/Gfx.hx",37,0xf24b1333)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("format.gfx.Gfx","moveTo",0x77dfcd8d,"format.gfx.Gfx.moveTo","format/gfx/Gfx.hx",39,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","lineTo",0x97d34130,"format.gfx.Gfx.lineTo","format/gfx/Gfx.hx",40,0xf24b1333)
		HX_STACK_THIS(this)
		HX_STACK_ARG(inX,"inX")
		HX_STACK_ARG(inY,"inY")
	}
...
{
		HX_STACK_FRAME("format.gfx.Gfx","curveTo",0xeff0b249,"format.gfx.Gfx.curveTo","format/gfx/Gfx.hx",41,0xf24b1333)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("format.gfx.Gfx","renderText",0xf6bf2644,"format.gfx.Gfx.renderText","format/gfx/Gfx.hx",43,0xf24b1333)
		HX_STACK_THIS(this)
...
Void Gfx_obj::eof( ){
{
		HX_STACK_FRAME("format.gfx.Gfx","eof",0x94718b7b,"format.gfx.Gfx.eof","format/gfx/Gfx.hx",45,0xf24b1333)
		HX_STACK_THIS(this)
	}
return null();
}
