...
{
HX_STACK_FRAME("format.SVG","new",0x8c78f8ff,"format.SVG.new","format/SVG.hx",23,0xed5ee212)
...
Void SVG_obj::render( ::flash::display::Graphics graphics,hx::Null< Float >  __o_x,hx::Null< Float >  __o_y,hx::Null< int >  __o_width,hx::Null< int >  __o_height){
Float x = __o_x.Default(0);
Float y = __o_y.Default(0);
int width = __o_width.Default(-1);
int height = __o_height.Default(-1);
	HX_STACK_FRAME("format.SVG","render",0xb7c63017,"format.SVG.render","format/SVG.hx",28,0xed5ee212)
	HX_STACK_THIS(this)
