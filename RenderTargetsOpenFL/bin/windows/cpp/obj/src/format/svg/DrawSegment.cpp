...
{
HX_STACK_FRAME("format.svg.DrawSegment","new",0xcfe52fa0,"format.svg.DrawSegment.new","format/svg/PathSegment.hx",60,0x6d7bc4b3)
...
{
		HX_STACK_FRAME("format.svg.DrawSegment","toGfx",0xf227e1fe,"format.svg.DrawSegment.toGfx","format/svg/PathSegment.hx",62,0x6d7bc4b3)
		HX_STACK_THIS(this)
...
int DrawSegment_obj::getType( ){
	HX_STACK_FRAME("format.svg.DrawSegment","getType",0x765da1b0,"format.svg.DrawSegment.getType","format/svg/PathSegment.hx",67,0x6d7bc4b3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
	return (int)2;
}
