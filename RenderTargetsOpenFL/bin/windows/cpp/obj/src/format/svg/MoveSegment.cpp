...
{
HX_STACK_FRAME("format.svg.MoveSegment","new",0xde0a69b3,"format.svg.MoveSegment.new","format/svg/PathSegment.hx",53,0x6d7bc4b3)
...
int MoveSegment_obj::getType( ){
	HX_STACK_FRAME("format.svg.MoveSegment","getType",0x2944e143,"format.svg.MoveSegment.getType","format/svg/PathSegment.hx",54,0x6d7bc4b3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
	return (int)1;
}
