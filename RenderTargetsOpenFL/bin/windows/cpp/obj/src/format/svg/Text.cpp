...
{
HX_STACK_FRAME("format.svg.Text","new",0x9481d320,"format.svg.Text.new","format/svg/Text.hx",11,0x00c6d00e)
{
}
;
	return null();
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::geom::Matrix*/ ,(int)offsetof(Text_obj,matrix),HX_CSTRING("matrix")},
