...
{
HX_STACK_FRAME("format.svg.QuadraticSegment","new",0x01245aae,"format.svg.QuadraticSegment.new","format/svg/PathSegment.hx",76,0x6d7bc4b3)
...
Float QuadraticSegment_obj::prevCX( ){
	HX_STACK_FRAME("format.svg.QuadraticSegment","prevCX",0x7af336da,"format.svg.QuadraticSegment.prevCX","format/svg/PathSegment.hx",82,0x6d7bc4b3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	return this->cx;
}
...
Float QuadraticSegment_obj::prevCY( ){
	HX_STACK_FRAME("format.svg.QuadraticSegment","prevCY",0x7af336db,"format.svg.QuadraticSegment.prevCY","format/svg/PathSegment.hx",83,0x6d7bc4b3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(83)
	return this->cy;
}
...
{
		HX_STACK_FRAME("format.svg.QuadraticSegment","toGfx",0x51d26c8c,"format.svg.QuadraticSegment.toGfx","format/svg/PathSegment.hx",86,0x6d7bc4b3)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(88)
		inGfx->curveTo(_g,ioContext->transY(this->cx,this->cy),ioContext->lastX,ioContext->lastY);
	}
return null();
}
...
int QuadraticSegment_obj::getType( ){
	HX_STACK_FRAME("format.svg.QuadraticSegment","getType",0xfdaa6bbe,"format.svg.QuadraticSegment.getType","format/svg/PathSegment.hx",92,0x6d7bc4b3)
	HX_STACK_THIS(this)
	HX_STACK_LINE(92)
	return (int)3;
}
