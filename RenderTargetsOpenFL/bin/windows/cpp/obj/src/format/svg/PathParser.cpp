...
Array< ::Dynamic > PathParser_obj::parse( ::String pathToParse,bool inConvertCubics){
	...
	while(((pos <= len))){
		...
		if (((command == ::format::svg::PathParser_obj::UNKNOWN))){
			HX_STACK_LINE(76)
			HX_STACK_DO_THROW(((HX_CSTRING("failed parsing path near '") + pathToParse.substr(pos,null())) + HX_CSTRING("'")));
		}
		HX_STACK_LINE(78)
		...
		if (((current_command >= (int)0))){
			...
			if (((current_args == args->length))){
				...
				if (((this->prev == null()))){
					HX_STACK_LINE(157)
					::String _g = ((HX_CSTRING("Unknown command ") + ::String::fromCharCode(current_command)) + HX_CSTRING(" near '"));		HX_STACK_VAR(_g,"_g");
					HX_STACK_LINE(157)
					HX_STACK_DO_THROW(((_g + pathToParse.substr(current_command_pos,null())) + HX_CSTRING("'")));
				}
				HX_STACK_LINE(159)
				if (((  ((inConvertCubics)) ? bool((this->prev->getType() == (int)4)) : bool(false) ))){
					HX_STACK_LINE(161)
					...
					HX_STACK_LINE(163)
					{
						...
						while(((_g < quads->length))){
							HX_STACK_LINE(163)
							::format::svg::QuadraticSegment q = quads->__get(_g).StaticCast< ::format::svg::QuadraticSegment >();		HX_STACK_VAR(q,"q");
							HX_STACK_LINE(163)
							++(_g);
							HX_STACK_LINE(164)
							segments->push(q);
	...
	if (((bool((current_command >= (int)0)) && bool(!(finished))))){
		HX_STACK_LINE(188)
		HX_STACK_DO_THROW(((((((HX_CSTRING("Unfinished command (") + args->length) + HX_CSTRING("/")) + current_args) + HX_CSTRING(") near '")) + pathToParse.substr(current_command_pos,null())) + HX_CSTRING("'")));
	}
	HX_STACK_LINE(192)
	return segments;
}
...
::format::svg::PathSegment PathParser_obj::createCommand( int code,Array< Float > a){
	...
	switch( (int)(code)){
		...
		case (int)108: {
			HX_STACK_LINE(239)
			Float _g = (a->__get((int)0) + this->prevX());		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(239)
			return ::format::svg::DrawSegment_obj::__new(_g,(a->__get((int)1) + this->prevY()));
		}
		;break;
		case (int)72: {
			HX_STACK_LINE(240)
		...
		case (int)104: {
			HX_STACK_LINE(241)
			Float _g1 = (a->__get((int)0) + this->prevX());		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(241)
			return ::format::svg::DrawSegment_obj::__new(_g1,this->prevY());
		}
		;break;
		case (int)86: {
			HX_STACK_LINE(242)
		...
		case (int)118: {
			HX_STACK_LINE(243)
			Float _g2 = this->prevX();		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(243)
			return ::format::svg::DrawSegment_obj::__new(_g2,(a->__get((int)0) + this->prevY()));
		}
		;break;
		case (int)67: {
			HX_STACK_LINE(245)
		...
		case (int)83: {
			...
			Float ry = this->prevY();		HX_STACK_VAR(ry,"ry");
			HX_STACK_LINE(253)
			Float _g3 = ((rx * (int)2) - this->prevCX());		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(253)
			return ::format::svg::CubicSegment_obj::__new(_g3,((ry * (int)2) - this->prevCY()),a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3));
		}
		;break;
		case (int)115: {
			HX_STACK_LINE(255)
			...
			Float ry = this->prevY();		HX_STACK_VAR(ry,"ry");
			HX_STACK_LINE(257)
			Float _g4 = ((rx * (int)2) - this->prevCX());		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(257)
			return ::format::svg::CubicSegment_obj::__new(_g4,((ry * (int)2) - this->prevCY()),(a->__get((int)0) + rx),(a->__get((int)1) + ry),(a->__get((int)2) + rx),(a->__get((int)3) + ry));
		}
		;break;
		case (int)81: {
			HX_STACK_LINE(258)
		...
		case (int)84: {
			...
			Float ry = this->prevY();		HX_STACK_VAR(ry,"ry");
			HX_STACK_LINE(266)
			Float _g5 = ((rx * (int)2) - this->prevCX());		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(266)
			return ::format::svg::QuadraticSegment_obj::__new(_g5,((rx * (int)2) - this->prevCY()),a->__get((int)2),a->__get((int)3));
		}
		;break;
		case (int)116: {
			HX_STACK_LINE(268)
			...
			Float ry = this->prevY();		HX_STACK_VAR(ry,"ry");
			HX_STACK_LINE(270)
			Float _g6 = ((rx * (int)2) - this->prevCX());		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(270)
			return ::format::svg::QuadraticSegment_obj::__new(_g6,((ry * (int)2) - this->prevCY()),(a->__get((int)0) + rx),(a->__get((int)1) + ry));
		}
		;break;
		case (int)65: {
			HX_STACK_LINE(272)
			Float _g7 = this->prevX();		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(272)
			return ::format::svg::ArcSegment_obj::__new(_g7,this->prevY(),a->__get((int)0),a->__get((int)1),a->__get((int)2),(a->__get((int)3) != 0.),(a->__get((int)4) != 0.),a->__get((int)5),a->__get((int)6));
		}
		;break;
		case (int)97: {
			HX_STACK_LINE(274)
