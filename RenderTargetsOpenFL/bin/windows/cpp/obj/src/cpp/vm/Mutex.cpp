...
{
HX_STACK_FRAME("cpp.vm.Mutex","new",0xabb3ca05,"cpp.vm.Mutex.new","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Mutex.hx",28,0xa98b2435)
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Mutex.hx",31,0xa98b2435)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Mutex.hx",37,0xa98b2435)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
