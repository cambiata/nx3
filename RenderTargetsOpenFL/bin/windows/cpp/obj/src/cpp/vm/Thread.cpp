...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",31,0x1f61cdde)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",46,0x1f61cdde)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","F:\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",53,0x1f61cdde)
