...
bool EReg_obj::match( ::String s){
	HX_STACK_FRAME("EReg","match",0x18fda1a6,"EReg.match","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",36,0xeadb2946)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(37)
...
::String EReg_obj::matched( int n){
	HX_STACK_FRAME("EReg","matched",0x8ce62f85,"EReg.matched","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",45,0xeadb2946)
	HX_STACK_THIS(this)
	HX_STACK_ARG(n,"n")
	HX_STACK_LINE(46)
...
Array< ::String > EReg_obj::split( ::String s){
	HX_STACK_FRAME("EReg","split",0x9749433b,"EReg.split","F:\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",74,0xeadb2946)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
