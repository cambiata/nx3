...
{
HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","F:\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",30,0xc6eb18a5)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("StringBuf","add",0xaa9f1675,"StringBuf.add","F:\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",41,0xc6eb18a5)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(41)
