...
hx::ObjectPtr< Elements_obj > Elements_obj::__new()
{  hx::ObjectPtr< Elements_obj > result = new Elements_obj();
	result->__construct();
	return result;}
...
::String Elements_obj::clefG;

::String Elements_obj::clefC;

::String Elements_obj::clefF;

::String Elements_obj::HVT4;

::String Elements_obj::noteBlack;

::String Elements_obj::HVT2;

::String Elements_obj::noteWhite;

::String Elements_obj::HVT1;

::String Elements_obj::noteWhole;

::String Elements_obj::signNatural;

::String Elements_obj::signSharp;

::String Elements_obj::signFlat;

::String Elements_obj::flagDown8;

::String Elements_obj::flagUp8;

::String Elements_obj::flagDown16;

::String Elements_obj::flagUp16;

::String Elements_obj::pauseNv4;

::String Elements_obj::pauseNv8;

::String Elements_obj::pauseNv16;

::String Elements_obj::time0;

::String Elements_obj::time1;

::String Elements_obj::time2;

::String Elements_obj::time3;

::String Elements_obj::time4;

::String Elements_obj::time5;

::String Elements_obj::time6;

::String Elements_obj::time7;

::String Elements_obj::time8;

::String Elements_obj::time9;

::String Elements_obj::timeCommon;

::String Elements_obj::timeAllabreve;

::String Elements_obj::tplCircle;

::String Elements_obj::tplCircleUp;

::String Elements_obj::tplArrowDown;

::String Elements_obj::tplArrowUp;

::String Elements_obj::tpl1;

::String Elements_obj::tpl2;

::String Elements_obj::tpl3;

::String Elements_obj::tpl4;

::String Elements_obj::tpl5;

::String Elements_obj::tpl6x;

::String Elements_obj::tpl6;

::String Elements_obj::tpl7;
...
Dynamic Elements_obj::__Field(const ::String &inName,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"HVT4") ) { return HVT4; }
		if (HX_FIELD_EQ(inName,"HVT2") ) { return HVT2; }
		if (HX_FIELD_EQ(inName,"HVT1") ) { return HVT1; }
		if (HX_FIELD_EQ(inName,"tpl1") ) { return tpl1; }
		if (HX_FIELD_EQ(inName,"tpl2") ) { return tpl2; }
		if (HX_FIELD_EQ(inName,"tpl3") ) { return tpl3; }
		if (HX_FIELD_EQ(inName,"tpl4") ) { return tpl4; }
		if (HX_FIELD_EQ(inName,"tpl5") ) { return tpl5; }
		if (HX_FIELD_EQ(inName,"tpl6") ) { return tpl6; }
		if (HX_FIELD_EQ(inName,"tpl7") ) { return tpl7; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"clefG") ) { return clefG; }
		if (HX_FIELD_EQ(inName,"clefC") ) { return clefC; }
		if (HX_FIELD_EQ(inName,"clefF") ) { return clefF; }
		if (HX_FIELD_EQ(inName,"time0") ) { return time0; }
		if (HX_FIELD_EQ(inName,"time1") ) { return time1; }
		if (HX_FIELD_EQ(inName,"time2") ) { return time2; }
		if (HX_FIELD_EQ(inName,"time3") ) { return time3; }
		if (HX_FIELD_EQ(inName,"time4") ) { return time4; }
		if (HX_FIELD_EQ(inName,"time5") ) { return time5; }
		if (HX_FIELD_EQ(inName,"time6") ) { return time6; }
		if (HX_FIELD_EQ(inName,"time7") ) { return time7; }
		if (HX_FIELD_EQ(inName,"time8") ) { return time8; }
		if (HX_FIELD_EQ(inName,"time9") ) { return time9; }
		if (HX_FIELD_EQ(inName,"tpl6x") ) { return tpl6x; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"flagUp8") ) { return flagUp8; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"signFlat") ) { return signFlat; }
		if (HX_FIELD_EQ(inName,"flagUp16") ) { return flagUp16; }
		if (HX_FIELD_EQ(inName,"pauseNv4") ) { return pauseNv4; }
		if (HX_FIELD_EQ(inName,"pauseNv8") ) { return pauseNv8; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"noteBlack") ) { return noteBlack; }
		if (HX_FIELD_EQ(inName,"noteWhite") ) { return noteWhite; }
		if (HX_FIELD_EQ(inName,"noteWhole") ) { return noteWhole; }
		if (HX_FIELD_EQ(inName,"signSharp") ) { return signSharp; }
		if (HX_FIELD_EQ(inName,"flagDown8") ) { return flagDown8; }
		if (HX_FIELD_EQ(inName,"pauseNv16") ) { return pauseNv16; }
		if (HX_FIELD_EQ(inName,"tplCircle") ) { return tplCircle; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"flagDown16") ) { return flagDown16; }
		if (HX_FIELD_EQ(inName,"timeCommon") ) { return timeCommon; }
		if (HX_FIELD_EQ(inName,"tplArrowUp") ) { return tplArrowUp; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"signNatural") ) { return signNatural; }
		if (HX_FIELD_EQ(inName,"tplCircleUp") ) { return tplCircleUp; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"tplArrowDown") ) { return tplArrowDown; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"timeAllabreve") ) { return timeAllabreve; }
	}
	return super::__Field(inName,inCallProp);
}

Dynamic Elements_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"HVT4") ) { HVT4=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"HVT2") ) { HVT2=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"HVT1") ) { HVT1=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl1") ) { tpl1=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl2") ) { tpl2=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl3") ) { tpl3=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl4") ) { tpl4=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl5") ) { tpl5=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl6") ) { tpl6=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl7") ) { tpl7=inValue.Cast< ::String >(); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"clefG") ) { clefG=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"clefC") ) { clefC=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"clefF") ) { clefF=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time0") ) { time0=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time1") ) { time1=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time2") ) { time2=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time3") ) { time3=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time4") ) { time4=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time5") ) { time5=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time6") ) { time6=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time7") ) { time7=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time8") ) { time8=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"time9") ) { time9=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tpl6x") ) { tpl6x=inValue.Cast< ::String >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"flagUp8") ) { flagUp8=inValue.Cast< ::String >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"signFlat") ) { signFlat=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"flagUp16") ) { flagUp16=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"pauseNv4") ) { pauseNv4=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"pauseNv8") ) { pauseNv8=inValue.Cast< ::String >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"noteBlack") ) { noteBlack=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"noteWhite") ) { noteWhite=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"noteWhole") ) { noteWhole=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"signSharp") ) { signSharp=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"flagDown8") ) { flagDown8=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"pauseNv16") ) { pauseNv16=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tplCircle") ) { tplCircle=inValue.Cast< ::String >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"flagDown16") ) { flagDown16=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"timeCommon") ) { timeCommon=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tplArrowUp") ) { tplArrowUp=inValue.Cast< ::String >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"signNatural") ) { signNatural=inValue.Cast< ::String >(); return inValue; }
		if (HX_FIELD_EQ(inName,"tplCircleUp") ) { tplCircleUp=inValue.Cast< ::String >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"tplArrowDown") ) { tplArrowDown=inValue.Cast< ::String >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"timeAllabreve") ) { timeAllabreve=inValue.Cast< ::String >(); return inValue; }
	}
	return super::__SetField(inName,inValue,inCallProp);
}

void Elements_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("clefF"),
	HX_CSTRING("HVT4"),
	HX_CSTRING("noteBlack"),
	HX_CSTRING("HVT2"),
	HX_CSTRING("noteWhite"),
	HX_CSTRING("HVT1"),
	HX_CSTRING("noteWhole"),
	HX_CSTRING("signNatural"),
	HX_CSTRING("signSharp"),
	HX_CSTRING("signFlat"),
	HX_CSTRING("flagDown8"),
	HX_CSTRING("flagUp8"),
	HX_CSTRING("flagDown16"),
	HX_CSTRING("flagUp16"),
	HX_CSTRING("pauseNv4"),
	HX_CSTRING("pauseNv8"),
	HX_CSTRING("pauseNv16"),
	HX_CSTRING("time0"),
	HX_CSTRING("time1"),
	HX_CSTRING("time2"),
	HX_CSTRING("time3"),
	...
	HX_CSTRING("time8"),
	HX_CSTRING("time9"),
	HX_CSTRING("timeCommon"),
	HX_CSTRING("timeAllabreve"),
	HX_CSTRING("tplCircle"),
	HX_CSTRING("tplCircleUp"),
	HX_CSTRING("tplArrowDown"),
	HX_CSTRING("tplArrowUp"),
	HX_CSTRING("tpl1"),
	HX_CSTRING("tpl2"),
	HX_CSTRING("tpl3"),
	HX_CSTRING("tpl4"),
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Elements_obj::__mClass,"__mClass");
	HX_MARK_MEMBER_NAME(Elements_obj::clefG,"clefG");
	HX_MARK_MEMBER_NAME(Elements_obj::clefC,"clefC");
	HX_MARK_MEMBER_NAME(Elements_obj::clefF,"clefF");
	HX_MARK_MEMBER_NAME(Elements_obj::HVT4,"HVT4");
	HX_MARK_MEMBER_NAME(Elements_obj::noteBlack,"noteBlack");
	HX_MARK_MEMBER_NAME(Elements_obj::HVT2,"HVT2");
	HX_MARK_MEMBER_NAME(Elements_obj::noteWhite,"noteWhite");
	HX_MARK_MEMBER_NAME(Elements_obj::HVT1,"HVT1");
	HX_MARK_MEMBER_NAME(Elements_obj::noteWhole,"noteWhole");
	HX_MARK_MEMBER_NAME(Elements_obj::signNatural,"signNatural");
	HX_MARK_MEMBER_NAME(Elements_obj::signSharp,"signSharp");
	HX_MARK_MEMBER_NAME(Elements_obj::signFlat,"signFlat");
	HX_MARK_MEMBER_NAME(Elements_obj::flagDown8,"flagDown8");
	HX_MARK_MEMBER_NAME(Elements_obj::flagUp8,"flagUp8");
	HX_MARK_MEMBER_NAME(Elements_obj::flagDown16,"flagDown16");
	HX_MARK_MEMBER_NAME(Elements_obj::flagUp16,"flagUp16");
	HX_MARK_MEMBER_NAME(Elements_obj::pauseNv4,"pauseNv4");
	HX_MARK_MEMBER_NAME(Elements_obj::pauseNv8,"pauseNv8");
	HX_MARK_MEMBER_NAME(Elements_obj::pauseNv16,"pauseNv16");
	HX_MARK_MEMBER_NAME(Elements_obj::time0,"time0");
	HX_MARK_MEMBER_NAME(Elements_obj::time1,"time1");
	HX_MARK_MEMBER_NAME(Elements_obj::time2,"time2");
	HX_MARK_MEMBER_NAME(Elements_obj::time3,"time3");
	HX_MARK_MEMBER_NAME(Elements_obj::time4,"time4");
	HX_MARK_MEMBER_NAME(Elements_obj::time5,"time5");
	HX_MARK_MEMBER_NAME(Elements_obj::time6,"time6");
	HX_MARK_MEMBER_NAME(Elements_obj::time7,"time7");
	HX_MARK_MEMBER_NAME(Elements_obj::time8,"time8");
	HX_MARK_MEMBER_NAME(Elements_obj::time9,"time9");
	HX_MARK_MEMBER_NAME(Elements_obj::timeCommon,"timeCommon");
	HX_MARK_MEMBER_NAME(Elements_obj::timeAllabreve,"timeAllabreve");
	HX_MARK_MEMBER_NAME(Elements_obj::tplCircle,"tplCircle");
	HX_MARK_MEMBER_NAME(Elements_obj::tplCircleUp,"tplCircleUp");
	HX_MARK_MEMBER_NAME(Elements_obj::tplArrowDown,"tplArrowDown");
	HX_MARK_MEMBER_NAME(Elements_obj::tplArrowUp,"tplArrowUp");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl1,"tpl1");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl2,"tpl2");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl3,"tpl3");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl4,"tpl4");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl5,"tpl5");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl6x,"tpl6x");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl6,"tpl6");
	HX_MARK_MEMBER_NAME(Elements_obj::tpl7,"tpl7");
};

#ifdef HXCPP_VISIT_ALLOCS
static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(Elements_obj::__mClass,"__mClass");
	HX_VISIT_MEMBER_NAME(Elements_obj::clefG,"clefG");
	HX_VISIT_MEMBER_NAME(Elements_obj::clefC,"clefC");
	HX_VISIT_MEMBER_NAME(Elements_obj::clefF,"clefF");
	HX_VISIT_MEMBER_NAME(Elements_obj::HVT4,"HVT4");
	HX_VISIT_MEMBER_NAME(Elements_obj::noteBlack,"noteBlack");
	HX_VISIT_MEMBER_NAME(Elements_obj::HVT2,"HVT2");
	HX_VISIT_MEMBER_NAME(Elements_obj::noteWhite,"noteWhite");
	HX_VISIT_MEMBER_NAME(Elements_obj::HVT1,"HVT1");
	HX_VISIT_MEMBER_NAME(Elements_obj::noteWhole,"noteWhole");
	HX_VISIT_MEMBER_NAME(Elements_obj::signNatural,"signNatural");
	HX_VISIT_MEMBER_NAME(Elements_obj::signSharp,"signSharp");
	HX_VISIT_MEMBER_NAME(Elements_obj::signFlat,"signFlat");
	HX_VISIT_MEMBER_NAME(Elements_obj::flagDown8,"flagDown8");
	HX_VISIT_MEMBER_NAME(Elements_obj::flagUp8,"flagUp8");
	HX_VISIT_MEMBER_NAME(Elements_obj::flagDown16,"flagDown16");
	HX_VISIT_MEMBER_NAME(Elements_obj::flagUp16,"flagUp16");
	HX_VISIT_MEMBER_NAME(Elements_obj::pauseNv4,"pauseNv4");
	HX_VISIT_MEMBER_NAME(Elements_obj::pauseNv8,"pauseNv8");
	HX_VISIT_MEMBER_NAME(Elements_obj::pauseNv16,"pauseNv16");
	HX_VISIT_MEMBER_NAME(Elements_obj::time0,"time0");
	HX_VISIT_MEMBER_NAME(Elements_obj::time1,"time1");
	HX_VISIT_MEMBER_NAME(Elements_obj::time2,"time2");
	HX_VISIT_MEMBER_NAME(Elements_obj::time3,"time3");
	HX_VISIT_MEMBER_NAME(Elements_obj::time4,"time4");
	HX_VISIT_MEMBER_NAME(Elements_obj::time5,"time5");
	HX_VISIT_MEMBER_NAME(Elements_obj::time6,"time6");
	HX_VISIT_MEMBER_NAME(Elements_obj::time7,"time7");
	HX_VISIT_MEMBER_NAME(Elements_obj::time8,"time8");
	HX_VISIT_MEMBER_NAME(Elements_obj::time9,"time9");
	HX_VISIT_MEMBER_NAME(Elements_obj::timeCommon,"timeCommon");
	HX_VISIT_MEMBER_NAME(Elements_obj::timeAllabreve,"timeAllabreve");
	HX_VISIT_MEMBER_NAME(Elements_obj::tplCircle,"tplCircle");
	HX_VISIT_MEMBER_NAME(Elements_obj::tplCircleUp,"tplCircleUp");
	HX_VISIT_MEMBER_NAME(Elements_obj::tplArrowDown,"tplArrowDown");
	HX_VISIT_MEMBER_NAME(Elements_obj::tplArrowUp,"tplArrowUp");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl1,"tpl1");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl2,"tpl2");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl3,"tpl3");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl4,"tpl4");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl5,"tpl5");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl6x,"tpl6x");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl6,"tpl6");
	HX_VISIT_MEMBER_NAME(Elements_obj::tpl7,"tpl7");
};

#endif

Class Elements_obj::__mClass;

void Elements_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("nx3.render.svg.Elements"), hx::TCanCast< Elements_obj> ,sStaticFields,sMemberFields,
