...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_FRAME("haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","F:\\HaxeToolkit\\haxe\\std/haxe/CallStack.hx",170,0x655c2527)
...
{
		HX_STACK_FRAME("haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","F:\\HaxeToolkit\\haxe\\std/haxe/CallStack.hx",180,0x655c2527)
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(180)
