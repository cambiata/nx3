...
{
HX_STACK_FRAME("haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",53,0xc23ddc89)
{
	HX_STACK_LINE(53)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","F:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",138,0xc23ddc89)
	HX_STACK_THIS(this)
	HX_STACK_LINE(154)
