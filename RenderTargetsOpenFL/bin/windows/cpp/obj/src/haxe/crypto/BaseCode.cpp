...
{
HX_STACK_FRAME("haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","F:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",33,0xc3150085)
...
::haxe::io::Bytes BaseCode_obj::encodeBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("haxe.crypto.BaseCode","encodeBytes",0x58a8e40a,"haxe.crypto.BaseCode.encodeBytes","F:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",44,0xc3150085)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(48)
...
{
		HX_STACK_FRAME("haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","F:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",72,0xc3150085)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
...
::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","F:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",81,0xc3150085)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(85)
	int nbits = this->nbits;		HX_STACK_VAR(nbits,"nbits");
		...
		while(((curbits < (int)8))){
			...
			struct _Function_3_1{
				inline static int Block( int &pin,::haxe::io::Bytes &b){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/crypto/BaseCode.hx",99,0xc3150085)
					{
						HX_STACK_LINE(99)
						int pos = (pin)++;		HX_STACK_VAR(pos,"pos");
						HX_STACK_LINE(99)
