...
{
HX_STACK_FRAME("haxe.Unserializer","new",0xa8f5e205,"haxe.Unserializer.new","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",99,0x0fc4c960)
...
{
		HX_STACK_FRAME("haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",125,0x0fc4c960)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(125)
		if (((r == null()))){
			struct _Function_2_1{
				inline static Dynamic Block( ){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",126,0x0fc4c960)
					{
						hx::Anon __result = hx::Anon_obj::Create();

						HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_3_1)
						::Class run(::String _){
							HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",127,0x0fc4c960)
							HX_STACK_ARG(_,"_")
							{
								HX_STACK_LINE(127)
								return null();
						...
						::Enum run(::String _){
							HX_STACK_FRAME("*","_Function_3_2",0x520271ba,"*._Function_3_2","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",128,0x0fc4c960)
							HX_STACK_ARG(_,"_")
							{
								HX_STACK_LINE(128)
								return null();
...
int Unserializer_obj::readDigits( ){
	HX_STACK_FRAME("haxe.Unserializer","readDigits",0x75598b17,"haxe.Unserializer.readDigits","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",147,0x0fc4c960)
	HX_STACK_THIS(this)
	HX_STACK_LINE(148)
...
{
		HX_STACK_FRAME("haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",172,0x0fc4c960)
		HX_STACK_THIS(this)
		HX_STACK_ARG(o,"o")
		HX_STACK_LINE(173)
		while((true)){
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_FRAME("haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",187,0x0fc4c960)
	HX_STACK_THIS(this)
	HX_STACK_ARG(edecl,"edecl")
	HX_STACK_ARG(tag,"tag")
	struct _Function_1_1{
		inline static int Block( ::haxe::Unserializer_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",188,0x0fc4c960)
			{
				HX_STACK_LINE(188)
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_FRAME("haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",219,0x0fc4c960)
	HX_STACK_THIS(this)
	HX_STACK_LINE(220)
	{
		HX_STACK_LINE(220)
		...
		switch( (int)(_g)){
			...
			case (int)121: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",244,0x0fc4c960)
						{
							HX_STACK_LINE(244)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(244)
			...
			case (int)111: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",276,0x0fc4c960)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							return __result;
						}
			...
			case (int)115: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",371,0x0fc4c960)
						{
							HX_STACK_LINE(371)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(371)
				...
				while(((i < max))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",388,0x0fc4c960)
							{
								HX_STACK_LINE(388)
					...
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",389,0x0fc4c960)
							{
								HX_STACK_LINE(389)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(389)
					...
					struct _Function_4_3{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",391,0x0fc4c960)
							{
								HX_STACK_LINE(391)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(391)
					...
					struct _Function_4_4{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",393,0x0fc4c960)
							{
								HX_STACK_LINE(393)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(393)
				...
				if (((rest >= (int)2))){
					struct _Function_4_1{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",397,0x0fc4c960)
							{
								HX_STACK_LINE(397)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(397)
					...
					struct _Function_4_2{
						inline static int Block( int &i,::String &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",398,0x0fc4c960)
							{
								HX_STACK_LINE(398)
								int index = (i)++;		HX_STACK_VAR(index,"index");
								HX_STACK_LINE(398)
					...
					if (((rest == (int)3))){
						struct _Function_5_1{
							inline static int Block( int &i,::String &buf){
								HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",401,0x0fc4c960)
								{
									HX_STACK_LINE(401)
									int index = (i)++;		HX_STACK_VAR(index,"index");
									HX_STACK_LINE(401)
			...
			case (int)67: {
				...
				struct _Function_3_1{
					inline static int Block( ::haxe::Unserializer_obj *__this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",417,0x0fc4c960)
						{
							HX_STACK_LINE(417)
							int p = (__this->pos)++;		HX_STACK_VAR(p,"p");
							HX_STACK_LINE(417)
...
Array< int > Unserializer_obj::initCodes( ){
	HX_STACK_FRAME("haxe.Unserializer","initCodes",0xee42ccdb,"haxe.Unserializer.initCodes","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",67,0x0fc4c960)
	HX_STACK_LINE(72)
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_FRAME("haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","F:\\HaxeToolkit\\haxe\\std/haxe/Unserializer.hx",434,0x0fc4c960)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(434)
