...
nx3.render.TargetSpriteBase = function(target,scaling) {
	this.target = target;
	this.graphics = target.get_graphics();
	this.scaling = scaling;
};
$hxClasses["nx3.render.TargetSpriteBase"] = nx3.render.TargetSpriteBase;
nx3.render.TargetSpriteBase.__name__ = true;
nx3.render.TargetSpriteBase.__interfaces__ = [nx3.render.ITarget];
nx3.render.TargetSpriteBase.prototype = {
	test: function() {
...
nx3.render.TargetOpenFl = function(target,scaling) {
	...
	nx3.render.TargetSpriteBase.call(this,target,scaling);
};
$hxClasses["nx3.render.TargetOpenFl"] = nx3.render.TargetOpenFl;
nx3.render.TargetOpenFl.__name__ = true;
nx3.render.TargetOpenFl.__interfaces__ = [nx3.render.ITarget];
nx3.render.TargetOpenFl.__super__ = nx3.render.TargetSpriteBase;
nx3.render.TargetOpenFl.prototype = $extend(nx3.render.TargetSpriteBase.prototype,{
	getTarget: function() {
		return this.target;
	}
