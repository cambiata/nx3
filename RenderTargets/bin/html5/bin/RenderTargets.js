...
Main.prototype = $extend(flash.display.Sprite.prototype,{
	...
	,init: function() {
		...
		var render;
		var renderBig;
		render = new nx3.render.TargetSvg("#main",nx3.render.scaling.Scaling.NORMAL);
		this.test(render);
		renderBig = new nx3.render.TargetSvg("#big",nx3.render.scaling.Scaling.BIG);
		this.test(renderBig);
	}
...
nx3.render.TargetSvg.prototype = {
	...
	,testSymbol: function(x,y,xmlStr) {
		...
		haxe.Log.trace(gPathD,{ fileName : "TargetSvg.hx", lineNumber : 73, className : "nx3.render.TargetSvg", methodName : "testSymbol"});
