...
class PAttributesRectsCalculator
{
	...
	static public function getKeyRect(key:EKey):Rectangle
	{
		return switch key
		{
			...
			case EKey.Flat1, EKey.Sharp1: new Rectangle(0, -3, 2, 6);
			case EKey.Flat2, EKey.Sharp2: new Rectangle(0, -3, 3, 6);
			case EKey.Flat3, EKey.Sharp3: new Rectangle(0, -3, 4, 6);
			case EKey.Flat4, EKey.Sharp4: new Rectangle(0, -3, 5, 6);
			case EKey.Flat5, EKey.Sharp5: new Rectangle(0, -3, 6, 6);
		default:
