...
Main.render = function(code,target,renderer) {
	...
	var xmlelement = new js.JQuery("#xml");
...
nx3.PSystemBarWidthCalculator.__name__ = true;
...
nx3.PSystemGenerator.__name__ = true;
...
nx3.PSimpleBarWidthCalculator.__name__ = true;
...
nx3.render.RendererBase.prototype = {
	...
	,psystem: function(system,nx,ny) {
		...
		while(_g < _g1.length) {
			...
			this.target.rectangle(tx,ty,new nx3.geom.Rectangle(barX,-10,barWidth,40),1);
