...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Jonas Nyström", "SfxrTest", "Sound", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (SfxrTest)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (SfxrTest, Reflect.field (SfxrTest, "main"), []);
...
@:keep class DocumentClass extends SfxrTest {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Sound", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (SfxrTest, []);
			}
