...
ApplicationMain.preloader_onComplete = function(event) {
	...
	var hasMain = false;
	var _g = 0;
	var _g1 = Type.getClassFields(SfxrTest);
	while(_g < _g1.length) {
	...
	if(hasMain) Reflect.callMethod(SfxrTest,Reflect.field(SfxrTest,"main"),[]); else {
...
var SfxrTest = function() { };
$hxClasses["SfxrTest"] = SfxrTest;
SfxrTest.__name__ = ["SfxrTest"];
SfxrTest.main = function() {
	var params = new vault.SfxrParams();
	params.waveType = 1;
	params.squareDuty = 0.11111;
	params.startFrequency = 0.466665;
	params.slide = 0;
	params.attackTime = 0.0;
	params.sustainTime = 0.266665;
	params.decayTime = 0.21111000000000002;
	params.masterVolume = 1;
	var sfxr = new vault.Sfxr(params);
	sfxr.player();
	haxe.Timer.delay(function() {
		haxe.Log.trace(1,{ fileName : "SfxrTest.hx", lineNumber : 24, className : "SfxrTest", methodName : "main"});
		sfxr.player();
	},2000);
	haxe.Timer.delay(function() {
		haxe.Log.trace(2,{ fileName : "SfxrTest.hx", lineNumber : 29, className : "SfxrTest", methodName : "main"});
		sfxr.player();
	},3000);
};
...
DocumentClass.__super__ = SfxrTest;
DocumentClass.prototype = $extend(SfxrTest.prototype,{
