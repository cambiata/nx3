...
public  class Main extends nx3.render.TargetJFrame
{
	...
	{
		super();
		this.surface.paintFunction = ( (( haxe.root.Main_new_109__Fun.__hx_current != null )) ? (haxe.root.Main_new_109__Fun.__hx_current) : (haxe.root.Main_new_109__Fun.__hx_current = ((haxe.root.Main_new_109__Fun) (new haxe.root.Main_new_109__Fun()) )) );
	}
