...
public  class StringBuf extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__StringBuf(haxe.root.StringBuf __temp_me16)
	{
		__temp_me16.b = new java.lang.StringBuilder();
	}
	...
	{
		{
			boolean __temp_executeDef299 = true;
	...
	{
		{
			boolean __temp_executeDef300 = true;
			switch (field.hashCode())
			{
				case -1776922004:
				{
