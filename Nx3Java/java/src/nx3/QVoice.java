...
public  class QVoice extends nx3.NVoice
{
	...
	public static   void __hx_ctor_nx3_QVoice(nx3.QVoice __temp_me173, haxe.root.Array<java.lang.Object> notevalues, java.lang.Object notevalue, haxe.root.Array<java.lang.Object> headlevels, java.lang.Object levelrepeats, java.lang.String signs, nx3.EDirectionUAD direction)
	{
		java.lang.Object __temp_levelrepeats172 = ( (( levelrepeats == null )) ? (((java.lang.Object) (1) )) : (((java.lang.Object) (levelrepeats) )) );
		...
		while (( haxe.lang.Runtime.compare(r, __temp_levelrepeats172) < 0 ))
		{
		...
		int i = 0;
		{
			...
			while (( _g < _headlevels.length ))
			{
				int level = ((int) (haxe.lang.Runtime.toInt(_headlevels.__get(_g))) );
				 ++ _g;
				nx3.ESign sign = __temp_me173.getSign(asigns.__get(i));
				nx3.QHead head = new nx3.QHead(((java.lang.Object) (level) ), ((nx3.ESign) (sign) ));
				nx3.QNote note = new nx3.QNote(((java.lang.Object) (null) ), ((haxe.root.Array<java.lang.Object>) (null) ), ((nx3.NHead) (head) ), ((haxe.root.Array<nx3.NHead>) (null) ), ((nx3.ENoteVal) (__temp_me173.getNotevalue(((double) (haxe.lang.Runtime.toDouble(_notevalues.__get(i))) ))) ), haxe.lang.Runtime.toString(null), ((nx3.EDirectionUAD) (null) ));
				notes.push(note);
				i++;
			}
		...
		nx3.NVoice.__hx_ctor_nx3_NVoice(__temp_me173, notes, null, direction);
	}
	...
	{
		{
			java.lang.String __temp_svar817 = (val);
			int __temp_hash819 = __temp_svar817.hashCode();
			boolean __temp_executeDef818 = true;
			switch (__temp_hash819)
			{
				case 35:
				{
					if (__temp_svar817.equals("#")) 
					{
				...
				case 110:case 78:
				{
					if (( (( ( __temp_hash819 == 110 ) && __temp_svar817.equals("n") )) || __temp_svar817.equals("N") )) 
					{
						__temp_executeDef818 = false;
	...
	{
		{
			double __temp_switch820 = (val);
			if (( __temp_switch820 == 16.0 )) 
			{
				return nx3.ENoteVal.Nv16;
			}
			 else 
			{
				if (( __temp_switch820 == .16 )) 
				{
					return nx3.ENoteVal.Nv16dot;
				}
				 else 
				{
					if (( __temp_switch820 == 8.0 )) 
					{
						return nx3.ENoteVal.Nv8;
					}
					 else 
					{
						if (( __temp_switch820 == .8 )) 
						{
							return nx3.ENoteVal.Nv8dot;
						}
						 else 
						{
							if (( __temp_switch820 == 4.0 )) 
							{
								return nx3.ENoteVal.Nv4;
							}
							 else 
							{
								if (( __temp_switch820 == .4 )) 
								{
									return nx3.ENoteVal.Nv4dot;
								}
								 else 
								{
									if (( __temp_switch820 == 2.0 )) 
									{
										return nx3.ENoteVal.Nv2;
									}
									 else 
									{
										if (( __temp_switch820 == .2 )) 
										{
											return nx3.ENoteVal.Nv2dot;
										}
										 else 
										{
											if (( __temp_switch820 == 1.0 )) 
											{
												return nx3.ENoteVal.Nv1;
											}
											 else 
											{
												if (( __temp_switch820 == .1 )) 
												{
