...
public  class PColumnsGenerator_calcPositions_109__Fun extends haxe.lang.Function
{
	public    PColumnsGenerator_calcPositions_109__Fun()
	{
		super(2, 1);
	}
	
	
	public static  nx3.PColumnsGenerator_calcPositions_109__Fun __hx_current;
