...
public  class LetterResource extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_letters_LetterResource(LetterResource __temp_me61)
	{
		{
			__temp_me61.letters = new haxe.ds.StringMap<Path>();
		}
	...
	{
		{
			java.lang.String __temp_svar416 = (str);
			int __temp_hash418 = __temp_svar416.hashCode();
			boolean __temp_executeDef417 = true;
			switch (__temp_hash418)
			{
				case 115:case 105:
				{
					if (( (( ( __temp_hash418 == 115 ) && __temp_svar416.equals("s") )) || __temp_svar416.equals("i") )) 
					{
	...
	{
		{
			java.lang.String __temp_svar419 = (str);
			int __temp_hash421 = __temp_svar419.hashCode();
			boolean __temp_executeDef420 = true;
			switch (__temp_hash421)
			{
				case 106:case 105:
				{
					if (( (( ( __temp_hash421 == 106 ) && __temp_svar419.equals("j") )) || __temp_svar419.equals("i") )) 
					{
	...
	{
		{
			java.lang.String __temp_svar422 = (str);
			boolean __temp_executeDef423 = true;
			switch (__temp_svar422.hashCode())
			{
				case 103:
				{
					if (__temp_svar422.equals("g")) 
					{
	...
	public final   Path getLetter(java.lang.String str)
	{
		 ...
		 else 
		{
			...
			{
				java.lang.String __temp_svar411 = (str);
				boolean __temp_executeDef412 = true;
				switch (__temp_svar411.hashCode())
				{
					case 97:
					{
						if (__temp_svar411.equals("a")) 
						{
