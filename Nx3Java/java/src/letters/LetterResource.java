...
public  class LetterResource extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_letters_LetterResource(LetterResource __temp_me62)
	{
		{
			__temp_me62.letters = new haxe.ds.StringMap<Path>();
		}
	...
	{
		{
			java.lang.String __temp_svar433 = (str);
			int __temp_hash435 = __temp_svar433.hashCode();
			boolean __temp_executeDef434 = true;
			switch (__temp_hash435)
			{
				case 115:case 105:
				{
					if (( (( ( __temp_hash435 == 115 ) && __temp_svar433.equals("s") )) || __temp_svar433.equals("i") )) 
					{
	...
	{
		{
			java.lang.String __temp_svar436 = (str);
			int __temp_hash438 = __temp_svar436.hashCode();
			boolean __temp_executeDef437 = true;
			switch (__temp_hash438)
			{
				case 106:case 105:
				{
					if (( (( ( __temp_hash438 == 106 ) && __temp_svar436.equals("j") )) || __temp_svar436.equals("i") )) 
					{
	...
	{
		{
			java.lang.String __temp_svar439 = (str);
			boolean __temp_executeDef440 = true;
			switch (__temp_svar439.hashCode())
			{
				case 103:
				{
					if (__temp_svar439.equals("g")) 
					{
	...
	public final   Path getLetter(java.lang.String str)
	{
		 ...
		 else 
		{
			...
			{
				java.lang.String __temp_svar428 = (str);
				boolean __temp_executeDef429 = true;
				switch (__temp_svar428.hashCode())
				{
					case 97:
					{
						if (__temp_svar428.equals("a")) 
						{
