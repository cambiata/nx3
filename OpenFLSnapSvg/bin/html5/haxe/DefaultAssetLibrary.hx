...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/rabbit.svg", __ASSET__assets_rabbit_svg);
		type.set ("assets/rabbit.svg", Reflect.field (AssetType, "text".toUpperCase ()));
		...
		type.set ("assets/openfl.svg", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/rabbit.svg", "assets/rabbit.svg");
		type.set ("assets/rabbit.svg", Reflect.field (AssetType, "text".toUpperCase ()));
...
class __ASSET__assets_rabbit_svg extends null { }
