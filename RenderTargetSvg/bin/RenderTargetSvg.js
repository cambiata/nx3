...
Main.main = function() {
	...
	r.renderBar(nx3.test.TestBars.testBar1(),10,80);
	r.renderBar(nx3.test.TestBars.testBarSigns(),10,400);
	...
	r1.renderBar(nx3.test.TestBars.testBarSigns(),10,400);
	...
	r2.renderBar(nx3.test.TestBars.testBarSigns(),10,400);
};
var IMap = function() { };
IMap.__name__ = true;
Math.__name__ = true;
...
nx3.EHeadType = { __ename__ : true, __constructs__ : ["Normal","Rythmic","Crossed"] };
...
nx3.VCreateBeamgroups.__name__ = true;
...
nx3.VNoteHeadsRectsCalculator.prototype = {
	getHeadsRects: function() {
		...
		while(_g < _g1.length) {
			...
			rect = new nx3.geom.Rectangle(-headw,-1,2 * headw,2);
			var pos = 0.0;
...
nx3.render.Renderer.prototype = {
	...
	,heads: function(x,y,vnote,direction) {
		...
		while(_g1 < _g11.length) {
			var rect = _g11[_g1];
			++_g1;
			this.target.shape(x + rect.x * this.scaling.halfNoteWidth,y + rect.y * this.scaling.halfSpace,xmlStr);
		}
	}
...
nx3.render.TargetSvg.prototype = {
	...
	,testSymbol: function(x,y,xmlStr) {
		if(xmlStr == null) xmlStr = nx3.render.svg.Elements.noteWhite;
...
nx3.render.TestTarget.prototype = {
	test: function() {
		...
		this.target.testSymbol(60,80,nx3.render.svg.Elements.clefG);
		this.target.testSymbol(120,80,nx3.render.svg.Elements.clefC);
		this.target.testSymbol(180,80,nx3.render.svg.Elements.clefF);
	}
};
nx3.render.scaling = {};
...
nx3.test.TestBars.testBarSigns = function() {
	var vbar = new nx3.VBar(new nx3.NBar([new nx3.NPart([new nx3.NVoice([new nx3.QNote4(1,null,"#"),new nx3.QNote4(null,[-1,0],"#b"),new nx3.QNote4(null,[3,4,5],"nb#"),new nx3.QNote4(null,[-5,-2,-1],"nb#"),new nx3.QNote4(null,[0,3,6],"nb#")])]),new nx3.NPart([new nx3.NVoice([new nx3.QNote4(-1,null,"#"),new nx3.QNote4(0,null,"#"),new nx3.QNote4(-4,null,"n")]),new nx3.NVoice([new nx3.QNote2(null,[1,4],"bn")])])]));
	return vbar;
};
nx3.xml = {};
